...
object SchemaConverter {
  ...
  private val FormatMap: Map[String, ScalarType] = Map(
    "int8"                   -> ScalarType.IntegerType,
    "int16"                  -> ScalarType.IntegerType,
    "int32"                  -> ScalarType.IntegerType,
    "int64"                  -> ScalarType.LongType,
    "uint8"                  -> ScalarType.IntegerType,
    "uint16"                 -> ScalarType.IntegerType,
    "uint32"                 -> ScalarType.LongType,
    "uint64"                 -> ScalarType.LongType,
    "double-int"             -> ScalarType.LongType,
    "float"                  -> ScalarType.FloatType,
    "double"                 -> ScalarType.DoubleType,
    "decimal"                -> ScalarType.DecimalType,
    "decimal128"             -> ScalarType.DecimalType,
    "date"                   -> ScalarType.DateIso8601Type,
    "date-time"              -> ScalarType.DateTimeIso8601Type,
    "date-time-local"        -> ScalarType.StringType,
    "http-date"              -> ScalarType.StringType,
    "duration"               -> ScalarType.StringType,
    "unixtime"               -> ScalarType.LongType,
    "uuid"                   -> ScalarType.UuidType,
    "uri"                    -> ScalarType.StringType,
    "uri-reference"          -> ScalarType.StringType,
    "uri-template"           -> ScalarType.StringType,
    "iri"                    -> ScalarType.StringType,
    "iri-reference"          -> ScalarType.StringType,
    "email"                  -> ScalarType.StringType,
    "idn-email"              -> ScalarType.StringType,
    "hostname"               -> ScalarType.StringType,
    "idn-hostname"           -> ScalarType.StringType,
    "byte"                   -> ScalarType.StringType,
    "binary"                 -> ScalarType.StringType,
    "base64url"              -> ScalarType.StringType,
    "sf-binary"              -> ScalarType.StringType,
    "password"               -> ScalarType.StringType,
    "html"                   -> ScalarType.StringType,
    "commonmark"             -> ScalarType.StringType,
    "media-range"            -> ScalarType.StringType,
    "json-pointer"           -> ScalarType.StringType,
    "relative-json-pointer"  -> ScalarType.StringType,
    "regex"                  -> ScalarType.StringType,
    "char"                   -> ScalarType.StringType,
  )
