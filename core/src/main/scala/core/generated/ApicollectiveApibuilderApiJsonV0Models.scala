  ...
  package object json {
    ...
    implicit def jsonReadsApibuilderApiJsonApiJson: play.api.libs.json.Reads[ApiJson] = {
      for {
        ...
        description <- (__ \ "description").readNullable[String]
        imports <- (__ \ "imports").read[Seq[io.apibuilder.api.json.v0.models.Import]]
        headers <- (__ \ "headers").read[Seq[io.apibuilder.api.json.v0.models.Header]]
        enums <- (__ \ "enums").read[Map[String, io.apibuilder.api.json.v0.models.Enum]]
        interfaces <- (__ \ "interfaces").read[Map[String, io.apibuilder.api.json.v0.models.Interface]]
        unions <- (__ \ "unions").read[Map[String, io.apibuilder.api.json.v0.models.Union]]
        models <- (__ \ "models").read[Map[String, io.apibuilder.api.json.v0.models.Model]]
        resources <- (__ \ "resources").read[Map[String, io.apibuilder.api.json.v0.models.Resource]]
        annotations <- (__ \ "annotations").read[Map[String, io.apibuilder.api.json.v0.models.Annotation]]
        attributes <- (__ \ "attributes").read[Seq[io.apibuilder.api.json.v0.models.Attribute]]
    ...
    implicit def jsonReadsApibuilderApiJsonParameter: play.api.libs.json.Reads[Parameter] = {
      for {
        name <- (__ \ "name").read[String]
        `type` <- (__ \ "type").read[String]
        location <- (__ \ "location").read[io.apibuilder.api.json.v0.models.ParameterLocation]
        description <- (__ \ "description").readNullable[String]
        required <- (__ \ "required").read[Boolean]
        default <- (__ \ "default").readNullable[String]
        minimum <- (__ \ "minimum").readNullable[Long]
