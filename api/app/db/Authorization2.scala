...
object Authorization2 {
  ...
  case object All extends Authorization2 {
  ...
  case class User(userGuid: UUID) extends Authorization2 {
  ...
  def apply(userGuid: Option[UUID]): Authorization2 = {
    userGuid match {
