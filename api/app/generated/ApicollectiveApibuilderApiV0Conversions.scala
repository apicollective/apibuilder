...
package io.apibuilder.api.v0.anorm.conversions {
  ...
  object Types {
    ...
    implicit val columnToMapApibuilderApiBatchDownloadFormApplication: Column[Map[String, _root_.io.apibuilder.api.v0.models.BatchDownloadFormApplication]] = Util.parser { _.as[Map[String, _root_.io.apibuilder.api.v0.models.BatchDownloadFormApplication]] }
    implicit val columnToSeqApibuilderApiBatchForm: Column[Seq[_root_.io.apibuilder.api.v0.models.BatchForm]] = Util.parser { _.as[Seq[_root_.io.apibuilder.api.v0.models.BatchForm]] }
    implicit val columnToMapApibuilderApiBatchForm: Column[Map[String, _root_.io.apibuilder.api.v0.models.BatchForm]] = Util.parser { _.as[Map[String, _root_.io.apibuilder.api.v0.models.BatchForm]] }
