...
package io.apibuilder.api.v0.anorm.parsers {
  ...
  object BatchDownloadForm {

    def parserWithPrefix(prefix: String, sep: String = "_"): RowParser[io.apibuilder.api.v0.models.BatchDownloadForm] = parser(prefixOpt = Some(s"$prefix$sep"))

    def parser(
      applications: String = "applications",
      prefixOpt: Option[String] = None
    ): RowParser[io.apibuilder.api.v0.models.BatchDownloadForm] = {
      SqlParser.get[Seq[io.apibuilder.api.v0.models.BatchDownloadFormApplication]](prefixOpt.getOrElse("") + applications) map {
        case applications => {
          io.apibuilder.api.v0.models.BatchDownloadForm(
            applications = applications
          )
        }
      }
  ...
  object BatchDownloadFormApplication {

    def parserWithPrefix(prefix: String, sep: String = "_"): RowParser[io.apibuilder.api.v0.models.BatchDownloadFormApplication] = parser(prefixOpt = Some(s"$prefix$sep"))

    def parser(
      applicationKey: String = "application_key",
      version: String = "version",
      prefixOpt: Option[String] = None
    ): RowParser[io.apibuilder.api.v0.models.BatchDownloadFormApplication] = {
      SqlParser.str(prefixOpt.getOrElse("") + applicationKey) ~
      SqlParser.str(prefixOpt.getOrElse("") + version) map {
        case applicationKey ~ version => {
          io.apibuilder.api.v0.models.BatchDownloadFormApplication(
  ...
  object BatchForm {
    ...
    def parserWithPrefix(prefix: String, sep: String = "_"): RowParser[io.apibuilder.api.v0.models.BatchForm] = parser(prefixOpt = Some(s"$prefix$sep"))

    def parser(
      applications: String = "applications",
      prefixOpt: Option[String] = None
    ): RowParser[io.apibuilder.api.v0.models.BatchForm] = {
      SqlParser.get[Seq[io.apibuilder.api.v0.models.VersionForm]](prefixOpt.getOrElse("") + applications) map {
        case applications => {
          io.apibuilder.api.v0.models.BatchForm(
            applications = applications
          )
        }
      }
