...
case class ServiceDiff(
  ...
  private def diffApidoc(): Seq[Diff] = {
  ...
  private def diffFields(modelName: String, a: Seq[Field], b: Seq[Field]): Seq[Diff] = {
  ...
  private def diffField(modelName: String, a: Field, b: Field): Seq[Diff] = {
