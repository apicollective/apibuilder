...
import io.apibuilder.apidoc.api.v0.models.{Authentication, PasswordReset, PasswordResetRequest, User}
import io.apibuilder.apidoc.api.v0.errors.ErrorsResponse
