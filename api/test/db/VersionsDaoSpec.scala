...
class VersionsDaoSpec extends FunSpec with Matchers {
  ...
  it("sorts properly") {
    ...
    val version1 = VersionsDao.create(Util.createdBy, app, "1.0.2", OriginalJson, service)
    val version2 = VersionsDao.create(Util.createdBy, app, "1.0.2-dev", OriginalJson, service)
