...
import io.apibuilder.apidoc.api.v0.models.{ApplicationForm, OriginalType, Version, Visibility}
import io.apibuilder.apidoc.spec.v0.models.{Application, Organization, Service}
...
class VersionsDaoSpec extends FunSpec with Matchers with util.TestApplication {
  ...
  private[this] val Original = io.apibuilder.apidoc.api.v0.models.Original(
  ...
  private[this] def createApplication(key: String = "test-" + UUID.randomUUID.toString): io.apibuilder.apidoc.api.v0.models.Application = {
  ...
  describe("with an application") {
    ...
    val application: io.apibuilder.apidoc.api.v0.models.Application = createApplication(applicationKey)
