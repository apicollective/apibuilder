...
module Apidoc
  ...
  class Client
    ...
    USER_AGENT = 'apidoc:0.6.13 http://www.apidoc.me/gilt/code/apidoc/0.6.3/ruby_client' unless defined?(USER_AGENT)
  ...
  module Clients
    ...
    class Generators
      ...
      def put_by_guid(guid, generator_update_form)
        ...
        @client.request("/generators/#{guid}").with_json(generator_update_form.to_json).put { |hash| Apidoc::Models::Generator.new(hash) }
      end
      ...
      def put_by_guid_and_org(guid, org, generator_org_form)
        ...
        @client.request("/generators/#{guid}/#{CGI.escape(org)}").with_json(generator_org_form.to_json).put { |hash| Apidoc::Models::Generator.new(hash) }
      end
  ...
  module Models
    ...
    class Code
      ...
      attr_reader :generator_key, :source

      def initialize(incoming={})
        opts = HttpClient::Helper.symbolize_keys(incoming)
        puts opts.keys.inspect
        @generator_key = HttpClient::Preconditions.assert_class('generator_key', opts.delete(:generator_key), String)
    ...
    class Generator
      ...
      def initialize(incoming={})
        ...
        @owner_guid = HttpClient::Preconditions.assert_class('owner_guid', HttpClient::Helper.to_uuid(opts.delete(:owner_guid)), String)
