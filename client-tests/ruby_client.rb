...
# apidoc:0.7.39 http://localhost:9000/gilt/apidoc/0.7.40/ruby_client
...
module Apidoc
  ...
  class Client
    ...
    USER_AGENT = 'apidoc:0.7.39 http://localhost:9000/gilt/apidoc/0.7.40/ruby_client' unless defined?(USER_AGENT)
    ...
    def applications
      @applications ||= Apidoc::Clients::Applications.new(self)
    end
    ...
    def email_verification_confirmation_forms
      @email_verification_confirmation_forms ||= Apidoc::Clients::EmailVerificationConfirmationForms.new(self)
    end
  ...
  module Clients
    ...
    class Applications
      ...
      def get_by_org_key(org_key, incoming={})
        ...
        @client.request("/#{CGI.escape(org_key)}").with_query(query).get.map { |hash| Apidoc::Models::Application.new(hash) }
      end

      # Create an application.
      def post_by_org_key(org_key, application_form)
        HttpClient::Preconditions.assert_class('org_key', org_key, String)
        HttpClient::Preconditions.assert_class('application_form', application_form, Apidoc::Models::ApplicationForm)
        @client.request("/#{CGI.escape(org_key)}").with_json(application_form.to_json).post { |hash| Apidoc::Models::Application.new(hash) }
      end
      ...
      def put_by_org_key_and_application_key(org_key, application_key, application_form)
        ...
        HttpClient::Preconditions.assert_class('application_form', application_form, Apidoc::Models::ApplicationForm)
        @client.request("/#{CGI.escape(org_key)}/#{CGI.escape(application_key)}").with_json(application_form.to_json).put { |hash| Apidoc::Models::Application.new(hash) }
      end
      ...
      def delete_by_org_key_and_application_key(org_key, application_key)
        HttpClient::Preconditions.assert_class('org_key', org_key, String)
        HttpClient::Preconditions.assert_class('application_key', application_key, String)
        @client.request("/#{CGI.escape(org_key)}/#{CGI.escape(application_key)}").delete { |hash| Apidoc::Models::Value.new(hash) }
      end
    ...
    class Code
      ...
      def get_by_org_key_and_application_key_and_version_and_generator_key(org_key, application_key, version, generator_key)
        ...
        @client.request("/#{CGI.escape(org_key)}/#{CGI.escape(application_key)}/#{CGI.escape(version)}/#{CGI.escape(generator_key)}").get { |hash| Apidoc::Models::Code.new(hash) }
      end
    ...
    class Domains
      ...
      def delete_by_org_key_and_name(org_key, name)
        ...
        @client.request("/domains/#{CGI.escape(org_key)}/#{CGI.escape(name)}").delete { |hash| Apidoc::Models::Value.new(hash) }
      end
    ...
    class EmailVerificationConfirmationForms
      ...
      def post_email_verification_confirmations(email_verification_confirmation_form)
        HttpClient::Preconditions.assert_class('email_verification_confirmation_form', email_verification_confirmation_form, Apidoc::Models::EmailVerificationConfirmationForm)
        @client.request("/email_verification_confirmations").with_json(email_verification_confirmation_form.to_json).post { |hash| Apidoc::Models::Value.new(hash) }
      end
    ...
    class Generators
      ...
      def delete_by_key(key)
        HttpClient::Preconditions.assert_class('key', key, String)
        @client.request("/generators/#{CGI.escape(key)}").delete { |hash| Apidoc::Models::Value.new(hash) }
      end
    ...
    class Memberships
      ...
      def delete_by_guid(guid)
        HttpClient::Preconditions.assert_class('guid', guid, String)
        @client.request("/memberships/#{guid}").delete { |hash| Apidoc::Models::Value.new(hash) }
      end
    ...
    class MembershipRequests
      ...
      def post_accept_by_guid(guid, hash)
        HttpClient::Preconditions.assert_class('guid', guid, String)
        HttpClient::Preconditions.assert_class('hash', hash, Hash)
        @client.request("/membership_requests/#{guid}/accept").with_json(hash.to_json).post { |hash| Apidoc::Models::Value.new(hash) }
      end
      ...
      def post_decline_by_guid(guid, hash)
        HttpClient::Preconditions.assert_class('guid', guid, String)
        HttpClient::Preconditions.assert_class('hash', hash, Hash)
        @client.request("/membership_requests/#{guid}/decline").with_json(hash.to_json).post { |hash| Apidoc::Models::Value.new(hash) }
      end
    ...
    class Organizations
      ...
      def put_by_key(key, organization_form)
        HttpClient::Preconditions.assert_class('key', key, String)
        HttpClient::Preconditions.assert_class('organization_form', organization_form, Apidoc::Models::OrganizationForm)
        @client.request("/organizations/#{CGI.escape(key)}").with_json(organization_form.to_json).put { |hash| Apidoc::Models::Organization.new(hash) }
      end

      # Deletes an organization and all of its associated applications.
      def delete_by_key(key)
        HttpClient::Preconditions.assert_class('key', key, String)
        @client.request("/organizations/#{CGI.escape(key)}").delete { |hash| Apidoc::Models::Value.new(hash) }
      end
    ...
    class PasswordResetRequests
      ...
      def post(password_reset_request)
        HttpClient::Preconditions.assert_class('password_reset_request', password_reset_request, Apidoc::Models::PasswordResetRequest)
        @client.request("/password_reset_requests").with_json(password_reset_request.to_json).post { |hash| Apidoc::Models::Value.new(hash) }
      end
    ...
    class Subscriptions
      ...
      def delete_by_guid(guid)
        HttpClient::Preconditions.assert_class('guid', guid, String)
        @client.request("/subscriptions/#{guid}").delete { |hash| Apidoc::Models::Value.new(hash) }
      end
    ...
    class Versions
      ...
      def get_by_org_key_and_application_key(org_key, application_key, incoming={})
        ...
        @client.request("/#{CGI.escape(org_key)}/#{CGI.escape(application_key)}").with_query(query).get.map { |hash| Apidoc::Models::Version.new(hash) }
      end
      ...
      def get_by_org_key_and_application_key_and_version(org_key, application_key, version)
        ...
        HttpClient::Preconditions.assert_class('application_key', application_key, String)
        HttpClient::Preconditions.assert_class('version', version, String)
        @client.request("/#{CGI.escape(org_key)}/#{CGI.escape(application_key)}/#{CGI.escape(version)}").get { |hash| Apidoc::Models::Version.new(hash) }
      end
      ...
      def post_by_org_key_and_version(org_key, version, version_form)
        HttpClient::Preconditions.assert_class('org_key', org_key, String)
        HttpClient::Preconditions.assert_class('version', version, String)
        HttpClient::Preconditions.assert_class('version_form', version_form, Apidoc::Models::VersionForm)
        @client.request("/#{CGI.escape(org_key)}/#{CGI.escape(version)}").with_json(version_form.to_json).post { |hash| Apidoc::Models::Version.new(hash) }
      end
      ...
      def put_by_org_key_and_application_key_and_version(org_key, application_key, version, version_form)
        ...
        HttpClient::Preconditions.assert_class('version', version, String)
        HttpClient::Preconditions.assert_class('version_form', version_form, Apidoc::Models::VersionForm)
        @client.request("/#{CGI.escape(org_key)}/#{CGI.escape(application_key)}/#{CGI.escape(version)}").with_json(version_form.to_json).put { |hash| Apidoc::Models::Version.new(hash) }
      end
      ...
      def delete_by_org_key_and_application_key_and_version(org_key, application_key, version)
        ...
        HttpClient::Preconditions.assert_class('application_key', application_key, String)
        HttpClient::Preconditions.assert_class('version', version, String)
        @client.request("/#{CGI.escape(org_key)}/#{CGI.escape(application_key)}/#{CGI.escape(version)}").delete { |hash| Apidoc::Models::Value.new(hash) }
      end
    ...
    class Watches
      ...
      def delete_by_guid(guid)
        HttpClient::Preconditions.assert_class('guid', guid, String)
        @client.request("/watches/#{guid}").delete { |hash| Apidoc::Models::Value.new(hash) }
      end
  ...
  module Models
    ...
    class Application
      ...
      def initialize(incoming={})
        ...
        @organization = HttpClient::Preconditions.assert_class('organization', opts[:organization].nil? ? nil : (opts[:organization].is_a?(Apidoc::Models::Reference) ? opts.delete(:organization) : Apidoc::Models::Reference.new(opts.delete(:organization))), Apidoc::Models::Reference)
    ...
    class Version
      ...
      def initialize(incoming={})
        ...
        @guid = HttpClient::Preconditions.assert_class('guid', HttpClient::Helper.to_uuid(opts.delete(:guid)), String)
        @organization = HttpClient::Preconditions.assert_class('organization', opts[:organization].nil? ? nil : (opts[:organization].is_a?(Apidoc::Models::Reference) ? opts.delete(:organization) : Apidoc::Models::Reference.new(opts.delete(:organization))), Apidoc::Models::Reference)
        @application = HttpClient::Preconditions.assert_class('application', opts[:application].nil? ? nil : (opts[:application].is_a?(Apidoc::Models::Reference) ? opts.delete(:application) : Apidoc::Models::Reference.new(opts.delete(:application))), Apidoc::Models::Reference)
    ...
    class Watch
      ...
      def initialize(incoming={})
        ...
        @user = HttpClient::Preconditions.assert_class('user', opts[:user].nil? ? nil : (opts[:user].is_a?(Apidoc::Models::User) ? opts.delete(:user) : Apidoc::Models::User.new(opts.delete(:user))), Apidoc::Models::User)
        @organization = HttpClient::Preconditions.assert_class('organization', opts[:organization].nil? ? nil : (opts[:organization].is_a?(Apidoc::Models::Organization) ? opts.delete(:organization) : Apidoc::Models::Organization.new(opts.delete(:organization))), Apidoc::Models::Organization)
        @application = HttpClient::Preconditions.assert_class('application', opts[:application].nil? ? nil : (opts[:application].is_a?(Apidoc::Models::Application) ? opts.delete(:application) : Apidoc::Models::Application.new(opts.delete(:application))), Apidoc::Models::Application)
      end
