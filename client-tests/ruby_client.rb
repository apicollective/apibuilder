...
# apidoc:0.7.36 http://www.apidoc.me/gilt/apidoc/0.7.36/ruby_client
...
module Apidoc
  ...
  class Client
    ...
    USER_AGENT = 'apidoc:0.7.36 http://www.apidoc.me/gilt/apidoc/0.7.36/ruby_client' unless defined?(USER_AGENT)
  ...
  module Clients
    ...
    class EmailVerificationConfirmationForms
      ...
      def post(email_verification_confirmation_form)
        ...
        @client.request("/email_verification_confirmations").with_json(email_verification_confirmation_form.to_json).post
        nil
      end
    ...
    class PasswordResetRequests
      ...
      def post(password_reset_request)
        ...
        @client.request("/password_reset_requests").with_json(password_reset_request.to_json).post
        nil
      end
