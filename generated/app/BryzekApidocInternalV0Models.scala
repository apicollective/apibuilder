 ...
 * apidoc:0.11.4 http://localhost:9000/bryzek/apidoc-internal/0.11.4/play_2_x_json
 */
  ...
  package object json {
    ...
    def jsObjectTask(obj: com.bryzek.apidoc.internal.v0.models.Task) = {
      play.api.libs.json.Json.obj(
        ...
        case Some(x) => play.api.libs.json.Json.obj("last_error" -> play.api.libs.json.Json.toJson(x))
      })
    }
