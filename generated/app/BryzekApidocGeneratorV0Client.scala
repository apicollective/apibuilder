 ...
 * apidoc:0.11.4 http://localhost:9000/bryzek/apidoc-generator/0.11.4/play_2_4_client
 */
  ...
  package object json {
    ...
    def jsObjectFile(obj: com.bryzek.apidoc.generator.v0.models.File) = {
      play.api.libs.json.Json.obj(
        ...
        case Some(x) => play.api.libs.json.Json.obj("dir" -> play.api.libs.json.Json.toJson(x))
      })
    }
    ...
    def jsObjectGenerator(obj: com.bryzek.apidoc.generator.v0.models.Generator) = {
      play.api.libs.json.Json.obj(
        ...
        case None => play.api.libs.json.Json.obj()
        case Some(x) => play.api.libs.json.Json.obj("language" -> play.api.libs.json.Json.toJson(x))
      }) ++
    ...
    def jsObjectInvocationForm(obj: com.bryzek.apidoc.generator.v0.models.InvocationForm) = {
      play.api.libs.json.Json.obj(
        ...
        case None => play.api.libs.json.Json.obj()
        case Some(x) => play.api.libs.json.Json.obj("user_agent" -> play.api.libs.json.Json.toJson(x))
      })
    }
...
package com.bryzek.apidoc.generator.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apidoc:0.11.4 http://localhost:9000/bryzek/apidoc-generator/0.11.4/play_2_4_client"
    val Version = "0.11.4"
    val VersionMajor = 0
  ...
  class Client(
    ...
    object Healthchecks extends Healthchecks {
      override def get()(implicit ec: scala.concurrent.ExecutionContext): scala.concurrent.Future[com.bryzek.apidoc.generator.v0.models.Healthcheck] = {
  ...
  trait Healthchecks {
    def get()(implicit ec: scala.concurrent.ExecutionContext): scala.concurrent.Future[com.bryzek.apidoc.generator.v0.models.Healthcheck]
  }
