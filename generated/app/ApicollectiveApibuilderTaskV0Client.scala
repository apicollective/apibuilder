...
package io.apibuilder.task.v0.models {
  ...
  object TaskType {
    ...
    case object PurgeOldDeleted extends TaskType { override def toString = "purge_old_deleted" }
     ...
     * above.
     */
    val all: scala.List[TaskType] = scala.List(Email, CheckInvariants, IndexApplication, CleanupDeletions, ScheduleMigrateVersions, MigrateVersion, PurgeOldDeleted, ScheduleSyncGeneratorServices, SyncGeneratorService, DiffVersion, UserCreated)
