 ...
 * User agent: apibuilder app.apibuilder.io/apicollective/apibuilder-task/latest/play_2_9_scala_3_client
 */
...
package io.apibuilder.task.v0.models {
  ...
  package object json {
    ...
    implicit def jsonReadsApibuilderTaskEmailData[T <: io.apibuilder.task.v0.models.EmailData]: play.api.libs.json.Reads[T] = (json: play.api.libs.json.JsValue) => {
      val default = jsonReadsApibuilderTaskEmailDataApplicationCreated.reads(json).map(_.asInstanceOf[T])
...
package io.apibuilder.task.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apibuilder app.apibuilder.io/apicollective/apibuilder-task/latest/play_2_9_scala_3_client"
    val Version = "0.16.50"
    val VersionMajor = 0
