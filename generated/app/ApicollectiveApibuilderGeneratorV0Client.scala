 ...
 * apibuilder 0.14.3 localhost 9000/apicollective/apibuilder-generator/0.14.13/play_2_6_client
 */
  ...
  package object json {
    ...
    implicit def jsonReadsApibuilderGeneratorGenerator: play.api.libs.json.Reads[Generator] = {
      (
        ...
        (__ \ "attributes").readWithDefault[Seq[String]](Nil)
      )(Generator.apply _)
    }
    ...
    implicit def jsonReadsApibuilderGeneratorInvocationForm: play.api.libs.json.Reads[InvocationForm] = {
      (
        ...
        (__ \ "attributes").readWithDefault[Seq[io.apibuilder.generator.v0.models.Attribute]](Nil) and
...
package io.apibuilder.generator.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apibuilder 0.14.3 localhost 9000/apicollective/apibuilder-generator/0.14.13/play_2_6_client"
    val Version = "0.14.13"
    val VersionMajor = 0
