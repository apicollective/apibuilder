 ...
 * apibuilder:0.12.38 http://localhost:9000/apicollective/apibuilder-generator/0.12.46/play_2_4_client
 */
package io.apibuilder.generator.v0.models {
   ...
   * @param name
   * @param description
   * @param attributes The list of attributes that this code generator can use. You
   * can find the full list of available attributes and their descriptions at
   * http://apibuilder.io/doc/attributes
   * @param key
   * @param language A comma separate list of the programming language(s) that this
   * generator produces
   */
...
package io.apibuilder.generator.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apibuilder:0.12.38 http://localhost:9000/apicollective/apibuilder-generator/0.12.46/play_2_4_client"
    val Version = "0.12.46"
    val VersionMajor = 0
    ...
    object Generators extends Generators {
      override def get(
        ...
        _executeRequest("GET", s"/generators", queryParameters = queryParameters, requestHeaders = requestHeaders).map {
          ...
          case r => throw new io.apibuilder.generator.v0.errors.FailedRequest(r.status, s"Unsupported response code[${r.status}]. Expected: 200")
        }
      }
      ...
      override def getByKey(
        ...
        _executeRequest("GET", s"/generators/${play.utils.UriEncoding.encodePathSegment(key, "UTF-8")}", requestHeaders = requestHeaders).map {
          ...
          case r if r.status == 404 => throw new io.apibuilder.generator.v0.errors.UnitResponse(r.status)
          case r => throw new io.apibuilder.generator.v0.errors.FailedRequest(r.status, s"Unsupported response code[${r.status}]. Expected: 200, 404")
        }
      }
    }
    ...
    object Invocations extends Invocations {
      override def postByKey(
        ...
        _executeRequest("POST", s"/invocations/${play.utils.UriEncoding.encodePathSegment(key, "UTF-8")}", body = Some(payload), requestHeaders = requestHeaders).map {
          ...
          case r if r.status == 409 => throw new io.apibuilder.generator.v0.errors.ErrorsResponse(r)
          case r => throw new io.apibuilder.generator.v0.errors.FailedRequest(r.status, s"Unsupported response code[${r.status}]. Expected: 200, 409")
        }
      }
    }
    ...
    def parseJson[T](
      ...
      f(play.api.libs.json.Json.parse(r.body)) match {
        ...
        case play.api.libs.json.JsError(errors) => {
          throw new io.apibuilder.generator.v0.errors.FailedRequest(r.status, s"Invalid json for class[" + className + "]: " + errors.mkString(" "))
        }
      }
    }
