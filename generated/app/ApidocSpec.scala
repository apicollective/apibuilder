 ...
 * apidoc:0.7.39 http://localhost:9000/gilt/apidoc-spec/0.7.41/play_2_3_client
 */
...
package com.gilt.apidoc.spec.v0 {
  ...
  class Client(apiUrl: String, auth: scala.Option[com.gilt.apidoc.spec.v0.Authorization] = None) {
    ...
    private val UserAgent = "apidoc:0.7.39 http://localhost:9000/gilt/apidoc-spec/0.7.41/play_2_3_client"
