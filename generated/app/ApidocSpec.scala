 ...
 * apidoc:0.7.39 http://localhost:9000/gilt/apidoc-spec/0.7.39/play_2_3_client
 */
package com.gilt.apidoc.spec.models {
  ...
  case class Enum(
    name: String,
    description: _root_.scala.Option[String] = None,
    values: Seq[com.gilt.apidoc.spec.models.EnumValue]
  )
  ...
  case class Import(
    uri: String,
    namespace: String,
    organization: com.gilt.apidoc.spec.models.Organization,
    application: com.gilt.apidoc.spec.models.Application,
    version: String,
    models: Seq[String],
    enums: Seq[String]
  )
  ...
  case class Model(
    ...
    plural: String,
    description: _root_.scala.Option[String] = None,
    fields: Seq[com.gilt.apidoc.spec.models.Field]
  )

  case class Operation(
    method: com.gilt.apidoc.spec.models.Method,
    path: String,
    description: _root_.scala.Option[String] = None,
    body: _root_.scala.Option[com.gilt.apidoc.spec.models.Body] = None,
    parameters: Seq[com.gilt.apidoc.spec.models.Parameter] = Nil,
    responses: Seq[com.gilt.apidoc.spec.models.Response] = Nil
  )
  ...
  case class Parameter(
    name: String,
    `type`: String,
    location: com.gilt.apidoc.spec.models.ParameterLocation,
    description: _root_.scala.Option[String] = None,
    required: Boolean,
    default: _root_.scala.Option[String] = None,
    minimum: _root_.scala.Option[Long] = None,
  ...
  case class Resource(
    model: com.gilt.apidoc.spec.models.Model,
    description: _root_.scala.Option[String] = None,
    operations: Seq[com.gilt.apidoc.spec.models.Operation]
  )
  ...
  case class Service(
    ...
    description: _root_.scala.Option[String] = None,
    headers: Seq[com.gilt.apidoc.spec.models.Header],
    imports: Seq[com.gilt.apidoc.spec.models.Import],
    enums: Seq[com.gilt.apidoc.spec.models.Enum],
    models: Seq[com.gilt.apidoc.spec.models.Model],
    resources: Seq[com.gilt.apidoc.spec.models.Resource]
  )
...
package com.gilt.apidoc.spec.models {
  package object json {
    ...
    private[spec] implicit val jsonReadsUUID = __.read[String].map(java.util.UUID.fromString)

    private[spec] implicit val jsonWritesUUID = new Writes[java.util.UUID] {
      def writes(x: java.util.UUID) = JsString(x.toString)
    }

    private[spec] implicit val jsonReadsJodaDateTime = __.read[String].map { str =>
      import org.joda.time.format.ISODateTimeFormat.dateTimeParser
      dateTimeParser.parseDateTime(str)
    }

    private[spec] implicit val jsonWritesJodaDateTime = new Writes[org.joda.time.DateTime] {
    ...
    implicit val jsonReadsApidocspecEnum_Method = __.read[String].map(Method.apply)
    implicit val jsonWritesApidocspecEnum_Method = new Writes[Method] {
      def writes(x: Method) = JsString(x.toString)
    }

    implicit val jsonReadsApidocspecEnum_ParameterLocation = __.read[String].map(ParameterLocation.apply)
    implicit val jsonWritesApidocspecEnum_ParameterLocation = new Writes[ParameterLocation] {
    ...
    implicit def jsonReadsApidocspecEnum: play.api.libs.json.Reads[Enum] = {
      (
        ...
        (__ \ "values").readNullable[Seq[com.gilt.apidoc.spec.models.EnumValue]].map(_.getOrElse(Nil))
      )(Enum.apply _)
    }
    ...
    implicit def jsonWritesApidocspecEnum: play.api.libs.json.Writes[Enum] = {
      (
        ...
        (__ \ "values").write[Seq[com.gilt.apidoc.spec.models.EnumValue]]
    ...
    implicit def jsonReadsApidocspecImport: play.api.libs.json.Reads[Import] = {
      (
        ...
        (__ \ "organization").read[com.gilt.apidoc.spec.models.Organization] and
        (__ \ "application").read[com.gilt.apidoc.spec.models.Application] and
        (__ \ "version").read[String] and
        (__ \ "models").readNullable[Seq[String]].map(_.getOrElse(Nil)) and
        (__ \ "enums").readNullable[Seq[String]].map(_.getOrElse(Nil))
      )(Import.apply _)
    }
    ...
    implicit def jsonWritesApidocspecImport: play.api.libs.json.Writes[Import] = {
      (
        ...
        (__ \ "organization").write[com.gilt.apidoc.spec.models.Organization] and
        (__ \ "application").write[com.gilt.apidoc.spec.models.Application] and
        (__ \ "version").write[String] and
        (__ \ "models").write[Seq[String]] and
        (__ \ "enums").write[Seq[String]]
    ...
    implicit def jsonReadsApidocspecModel: play.api.libs.json.Reads[Model] = {
      (
        ...
        (__ \ "description").readNullable[String] and
        (__ \ "fields").readNullable[Seq[com.gilt.apidoc.spec.models.Field]].map(_.getOrElse(Nil))
      )(Model.apply _)
    }
    ...
    implicit def jsonWritesApidocspecModel: play.api.libs.json.Writes[Model] = {
      (
        ...
        (__ \ "description").write[scala.Option[String]] and
        (__ \ "fields").write[Seq[com.gilt.apidoc.spec.models.Field]]
      )(unlift(Model.unapply _))
    }

    implicit def jsonReadsApidocspecOperation: play.api.libs.json.Reads[Operation] = {
      (
        (__ \ "method").read[com.gilt.apidoc.spec.models.Method] and
        (__ \ "path").read[String] and
        (__ \ "description").readNullable[String] and
        (__ \ "body").readNullable[com.gilt.apidoc.spec.models.Body] and
        (__ \ "parameters").readNullable[Seq[com.gilt.apidoc.spec.models.Parameter]].map(_.getOrElse(Nil)) and
        (__ \ "responses").readNullable[Seq[com.gilt.apidoc.spec.models.Response]].map(_.getOrElse(Nil))
      )(Operation.apply _)
    }

    implicit def jsonWritesApidocspecOperation: play.api.libs.json.Writes[Operation] = {
      (
        (__ \ "method").write[com.gilt.apidoc.spec.models.Method] and
        (__ \ "path").write[String] and
        (__ \ "description").write[scala.Option[String]] and
        (__ \ "body").write[scala.Option[com.gilt.apidoc.spec.models.Body]] and
        (__ \ "parameters").write[Seq[com.gilt.apidoc.spec.models.Parameter]] and
        (__ \ "responses").write[Seq[com.gilt.apidoc.spec.models.Response]]
    ...
    implicit def jsonReadsApidocspecParameter: play.api.libs.json.Reads[Parameter] = {
      (
        (__ \ "name").read[String] and
        (__ \ "type").read[String] and
        (__ \ "location").read[com.gilt.apidoc.spec.models.ParameterLocation] and
        (__ \ "description").readNullable[String] and
        (__ \ "required").read[Boolean] and
        (__ \ "default").readNullable[String] and
        (__ \ "minimum").readNullable[Long] and
    ...
    implicit def jsonWritesApidocspecParameter: play.api.libs.json.Writes[Parameter] = {
      (
        (__ \ "name").write[String] and
        (__ \ "type").write[String] and
        (__ \ "location").write[com.gilt.apidoc.spec.models.ParameterLocation] and
        (__ \ "description").write[scala.Option[String]] and
        (__ \ "required").write[Boolean] and
        (__ \ "default").write[scala.Option[String]] and
        (__ \ "minimum").write[scala.Option[Long]] and
    ...
    implicit def jsonReadsApidocspecResource: play.api.libs.json.Reads[Resource] = {
      (
        (__ \ "model").read[com.gilt.apidoc.spec.models.Model] and
        (__ \ "description").readNullable[String] and
        (__ \ "operations").readNullable[Seq[com.gilt.apidoc.spec.models.Operation]].map(_.getOrElse(Nil))
      )(Resource.apply _)
    }

    implicit def jsonWritesApidocspecResource: play.api.libs.json.Writes[Resource] = {
      (
        (__ \ "model").write[com.gilt.apidoc.spec.models.Model] and
        (__ \ "description").write[scala.Option[String]] and
        (__ \ "operations").write[Seq[com.gilt.apidoc.spec.models.Operation]]
    ...
    implicit def jsonReadsApidocspecService: play.api.libs.json.Reads[Service] = {
      (
        ...
        (__ \ "description").readNullable[String] and
        (__ \ "headers").readNullable[Seq[com.gilt.apidoc.spec.models.Header]].map(_.getOrElse(Nil)) and
        (__ \ "imports").readNullable[Seq[com.gilt.apidoc.spec.models.Import]].map(_.getOrElse(Nil)) and
        (__ \ "enums").readNullable[Seq[com.gilt.apidoc.spec.models.Enum]].map(_.getOrElse(Nil)) and
        (__ \ "models").readNullable[Seq[com.gilt.apidoc.spec.models.Model]].map(_.getOrElse(Nil)) and
        (__ \ "resources").readNullable[Seq[com.gilt.apidoc.spec.models.Resource]].map(_.getOrElse(Nil))
      )(Service.apply _)
    }
    ...
    implicit def jsonWritesApidocspecService: play.api.libs.json.Writes[Service] = {
      (
        ...
        (__ \ "description").write[scala.Option[String]] and
        (__ \ "headers").write[Seq[com.gilt.apidoc.spec.models.Header]] and
        (__ \ "imports").write[Seq[com.gilt.apidoc.spec.models.Import]] and
        (__ \ "enums").write[Seq[com.gilt.apidoc.spec.models.Enum]] and
        (__ \ "models").write[Seq[com.gilt.apidoc.spec.models.Model]] and
        (__ \ "resources").write[Seq[com.gilt.apidoc.spec.models.Resource]]
      )(unlift(Service.unapply _))
    }
  }
}

package com.gilt.apidoc.spec {
  ...
  class Client(apiUrl: String, apiToken: scala.Option[String] = None) {
    ...
    private val logger = play.api.Logger("com.gilt.apidoc.spec.client")

    logger.info(s"Initializing com.gilt.apidoc.spec.client for url $apiUrl")
