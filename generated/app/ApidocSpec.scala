 ...
 * apidoc:0.7.39 http://www.apidoc.me/gilt/apidoc-spec/0.7.39/play_2_3_client
 */
package com.gilt.apidocspec.models {
  ...
  case class Import(
    uri: String,
    namespace: String,
    organization: com.gilt.apidocspec.models.Organization,
    application: com.gilt.apidocspec.models.Application,
    version: String,
    models: Seq[String],
    enums: Seq[String]
  )
  ...
  case class Operation(
    method: com.gilt.apidocspec.models.Method,
    path: String,
    description: scala.Option[String] = None,
    body: scala.Option[com.gilt.apidocspec.models.Body] = None,
    parameters: Seq[com.gilt.apidocspec.models.Parameter] = Nil,
    responses: Seq[com.gilt.apidocspec.models.Response] = Nil
  )
  ...
  case class Parameter(
    name: String,
    `type`: String,
    location: com.gilt.apidocspec.models.ParameterLocation,
    description: scala.Option[String] = None,
    required: Boolean,
    default: scala.Option[String] = None,
    minimum: scala.Option[Long] = None,
  ...
  case class Resource(
    model: com.gilt.apidocspec.models.Model,
    description: scala.Option[String] = None,
  ...
  case class Service(
    ...
    imports: Seq[com.gilt.apidocspec.models.Import],
    enums: Seq[com.gilt.apidocspec.models.Enum],
    models: Seq[com.gilt.apidocspec.models.Model],
    resources: Seq[com.gilt.apidocspec.models.Resource]
  )
  ...
  package object json {
    ...
    implicit def jsonReadsApidocspecImport: play.api.libs.json.Reads[Import] = {
      (
        ...
        (__ \ "organization").read[com.gilt.apidocspec.models.Organization] and
        (__ \ "application").read[com.gilt.apidocspec.models.Application] and
    ...
    implicit def jsonWritesApidocspecImport: play.api.libs.json.Writes[Import] = {
      (
        ...
        (__ \ "organization").write[com.gilt.apidocspec.models.Organization] and
        (__ \ "application").write[com.gilt.apidocspec.models.Application] and
    ...
    implicit def jsonReadsApidocspecOperation: play.api.libs.json.Reads[Operation] = {
      (
        (__ \ "method").read[com.gilt.apidocspec.models.Method] and
        (__ \ "path").read[String] and
        (__ \ "description").readNullable[String] and
        (__ \ "body").readNullable[com.gilt.apidocspec.models.Body] and
        (__ \ "parameters").readNullable[Seq[com.gilt.apidocspec.models.Parameter]].map(_.getOrElse(Nil)) and
        (__ \ "responses").readNullable[Seq[com.gilt.apidocspec.models.Response]].map(_.getOrElse(Nil))
      )(Operation.apply _)
    }

    implicit def jsonWritesApidocspecOperation: play.api.libs.json.Writes[Operation] = {
      (
        (__ \ "method").write[com.gilt.apidocspec.models.Method] and
        (__ \ "path").write[String] and
        (__ \ "description").write[scala.Option[String]] and
        (__ \ "body").write[scala.Option[com.gilt.apidocspec.models.Body]] and
        (__ \ "parameters").write[Seq[com.gilt.apidocspec.models.Parameter]] and
        (__ \ "responses").write[Seq[com.gilt.apidocspec.models.Response]]
    ...
    implicit def jsonReadsApidocspecParameter: play.api.libs.json.Reads[Parameter] = {
      (
        (__ \ "name").read[String] and
        (__ \ "type").read[String] and
        (__ \ "location").read[com.gilt.apidocspec.models.ParameterLocation] and
        (__ \ "description").readNullable[String] and
        (__ \ "required").read[Boolean] and
        (__ \ "default").readNullable[String] and
        (__ \ "minimum").readNullable[Long] and
    ...
    implicit def jsonWritesApidocspecParameter: play.api.libs.json.Writes[Parameter] = {
      (
        (__ \ "name").write[String] and
        (__ \ "type").write[String] and
        (__ \ "location").write[com.gilt.apidocspec.models.ParameterLocation] and
        (__ \ "description").write[scala.Option[String]] and
        (__ \ "required").write[Boolean] and
        (__ \ "default").write[scala.Option[String]] and
        (__ \ "minimum").write[scala.Option[Long]] and
    ...
    implicit def jsonReadsApidocspecResource: play.api.libs.json.Reads[Resource] = {
      (
        (__ \ "model").read[com.gilt.apidocspec.models.Model] and
        (__ \ "description").readNullable[String] and
    ...
    implicit def jsonWritesApidocspecResource: play.api.libs.json.Writes[Resource] = {
      (
        (__ \ "model").write[com.gilt.apidocspec.models.Model] and
        (__ \ "description").write[scala.Option[String]] and
    ...
    implicit def jsonReadsApidocspecService: play.api.libs.json.Reads[Service] = {
      (
        ...
        (__ \ "imports").readNullable[Seq[com.gilt.apidocspec.models.Import]].map(_.getOrElse(Nil)) and
        (__ \ "enums").readNullable[Seq[com.gilt.apidocspec.models.Enum]].map(_.getOrElse(Nil)) and
        (__ \ "models").readNullable[Seq[com.gilt.apidocspec.models.Model]].map(_.getOrElse(Nil)) and
        (__ \ "resources").readNullable[Seq[com.gilt.apidocspec.models.Resource]].map(_.getOrElse(Nil))
      )(Service.apply _)
    }
    ...
    implicit def jsonWritesApidocspecService: play.api.libs.json.Writes[Service] = {
      (
        ...
        (__ \ "imports").write[Seq[com.gilt.apidocspec.models.Import]] and
        (__ \ "enums").write[Seq[com.gilt.apidocspec.models.Enum]] and
        (__ \ "models").write[Seq[com.gilt.apidocspec.models.Model]] and
        (__ \ "resources").write[Seq[com.gilt.apidocspec.models.Resource]]
...
package com.gilt.apidocspec {
  ...
  class Client(apiUrl: String, apiToken: scala.Option[String] = None) {
    ...
    private val UserAgent = "apidoc:0.7.39 http://www.apidoc.me/gilt/apidoc-spec/0.7.39/play_2_3_client"
    private val logger = play.api.Logger("com.gilt.apidocspec.client")

    logger.info(s"Initializing com.gilt.apidocspec.client for url $apiUrl")
