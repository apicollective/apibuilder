 ...
 * apidoc:0.7.37 http://www.apidoc.me/gilt/apidoc-spec/0.7.40/play_2_3_client
 */
package com.gilt.apidocspec.models {
  ...
  /**
   * An import is used to declare a dependency on another service. This allows you to
   * reference the models and or enums from that service in your own service.
   */
  case class Import(
    uri: String
  )
...
package com.gilt.apidocspec.models {
  package object json {
    ...
    implicit def jsonWritesApidocspecImport: play.api.libs.json.Writes[Import] = new play.api.libs.json.Writes[Import] {
      def writes(x: Import) = play.api.libs.json.Json.obj(
...
package com.gilt.apidocspec {
  ...
  class Client(apiUrl: String, apiToken: scala.Option[String] = None) {
    ...
    private val UserAgent = "apidoc:0.7.37 http://www.apidoc.me/gilt/apidoc-spec/0.7.40/play_2_3_client"
