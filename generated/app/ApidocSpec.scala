 ...
 * apidoc:0.7.37 http://www.apidoc.me/gilt/apidoc-spec/0.7.40-dev/play_2_3_client
 */
  ...
  package object json {
    ...
    implicit def jsonReadsApidocspecImport: play.api.libs.json.Reads[Import] = {
      (
        ...
        (__ \ "application_key").read[String] and
    ...
    implicit def jsonWritesApidocspecImport: play.api.libs.json.Writes[Import] = {
      (
        ...
        (__ \ "application_key").write[String] and
...
package com.gilt.apidocspec {
  ...
  class Client(apiUrl: String, apiToken: scala.Option[String] = None) {
    ...
    private val UserAgent = "apidoc:0.7.37 http://www.apidoc.me/gilt/apidoc-spec/0.7.40-dev/play_2_3_client"
