...
<<<<<<< 7f4138aaa14fc32e55235ab5419a7ac37619ae3a
<<<<<<< 4c9bd867197bc1752a4c00133b07391b69738b8f
<<<<<<< 0e4647f79736ee69fa835910a94b0b0ebced64bd
 * Service version: 0.11.16
 * apidoc:0.11.15 http://www.apidoc.me/bryzek/apidoc-spec/0.11.16/play_2_4_client
=======
 * Service version: 0.9.49-SNAPSHOT
 * apidoc:0.9.48 http://dockerhost:9000/bryzek/apidoc-spec/0.9.49-SNAPSHOT/play_2_4_client
>>>>>>> POC implementation of attributes
=======
 * Service version: 0.12.0-SNAPSHOT
 * apidoc:0.11.5 http://dockerhost:9000/bryzek/apidoc-spec/0.12.0-SNAPSHOT/play_2_4_client
>>>>>>> Patch to fix error in curren play client generator
=======
 * Service version: 0.12.0-SNAPSHOT
 * apidoc:0.11.5 http://dockerhost:9000/bryzek/apidoc-spec/0.12.0-SNAPSHOT/play_2_4_client
>>>>>>> Update tests to support attributes
 */
...
>>>>>>> POC implementation of attributes
    ...
    def jsObjectAttribute(obj: com.bryzek.apidoc.spec.v0.models.Attribute) = {
      ...
      (obj.deprecation match {
        case None => play.api.libs.json.Json.obj()
        case Some(x) => play.api.libs.json.Json.obj("deprecation" -> play.api.libs.json.Json.toJson(x))
      })
    }
...
<<<<<<< e01ae447f4b4a35efb3fefeda4ed424e95ef7cac
<<<<<<< 0e4647f79736ee69fa835910a94b0b0ebced64bd
...
=======
      (
        ...
        (__ \ "description").writeNullable[String] and
        (__ \ "deprecation").writeNullable[com.bryzek.apidoc.spec.v0.models.Deprecation] and
        (__ \ "values").write[Seq[com.bryzek.apidoc.spec.v0.models.EnumValue]] and
        (__ \ "attributes").write[Seq[com.bryzek.apidoc.spec.v0.models.Attribute]]
...
>>>>>>> POC implementation of attributes
    ...
    def jsObjectField(obj: com.bryzek.apidoc.spec.v0.models.Field) = {
      ...
      (obj.default match {
        case None => play.api.libs.json.Json.obj()
        case Some(x) => play.api.libs.json.Json.obj("default" -> play.api.libs.json.Json.toJson(x))
      }) ++
      (obj.minimum match {
        case None => play.api.libs.json.Json.obj()
        case Some(x) => play.api.libs.json.Json.obj("minimum" -> play.api.libs.json.Json.toJson(x))
      }) ++
      (obj.maximum match {
        case None => play.api.libs.json.Json.obj()
        case Some(x) => play.api.libs.json.Json.obj("maximum" -> play.api.libs.json.Json.toJson(x))
      }) ++
      (obj.example match {
        case None => play.api.libs.json.Json.obj()
        case Some(x) => play.api.libs.json.Json.obj("example" -> play.api.libs.json.Json.toJson(x))
      })
    }
...
>>>>>>> POC implementation of attributes
    ...
    def jsObjectInfo(obj: com.bryzek.apidoc.spec.v0.models.Info) = {
      (obj.license match {
        case None => play.api.libs.json.Json.obj()
        case Some(x) => play.api.libs.json.Json.obj("license" -> play.api.libs.json.Json.toJson(x))
      }) ++
      (obj.contact match {
        case None => play.api.libs.json.Json.obj()
        case Some(x) => play.api.libs.json.Json.obj("contact" -> play.api.libs.json.Json.toJson(x))
      })
    }
...
=======
      (
        ...
        (__ \ "description").writeNullable[String] and
        (__ \ "deprecation").writeNullable[com.bryzek.apidoc.spec.v0.models.Deprecation] and
        (__ \ "fields").write[Seq[com.bryzek.apidoc.spec.v0.models.Field]] and
        (__ \ "attributes").write[Seq[com.bryzek.apidoc.spec.v0.models.Attribute]]
...
>>>>>>> POC implementation of attributes
    ...
    def jsObjectOperation(obj: com.bryzek.apidoc.spec.v0.models.Operation) = {
      ...
      (obj.body match {
        case None => play.api.libs.json.Json.obj()
        case Some(x) => play.api.libs.json.Json.obj("body" -> play.api.libs.json.Json.toJson(x))
      })
    }
...
=======
      (
        ...
        (__ \ "responses").write[Seq[com.bryzek.apidoc.spec.v0.models.Response]] and
        (__ \ "attributes").write[Seq[com.bryzek.apidoc.spec.v0.models.Attribute]]
...
=======
      (
        ...
        (__ \ "description").writeNullable[String] and
        (__ \ "deprecation").writeNullable[com.bryzek.apidoc.spec.v0.models.Deprecation] and
        (__ \ "operations").write[Seq[com.bryzek.apidoc.spec.v0.models.Operation]] and
        (__ \ "attributes").write[Seq[com.bryzek.apidoc.spec.v0.models.Attribute]]
...
>>>>>>> POC implementation of attributes
    ...
    def jsObjectService(obj: com.bryzek.apidoc.spec.v0.models.Service) = {
      play.api.libs.json.Json.obj(
        ...
        case None => play.api.libs.json.Json.obj()
        case Some(x) => play.api.libs.json.Json.obj("base_url" -> play.api.libs.json.Json.toJson(x))
      }) ++
      (obj.description match {
        case None => play.api.libs.json.Json.obj()
        case Some(x) => play.api.libs.json.Json.obj("description" -> play.api.libs.json.Json.toJson(x))
    ...
    def jsObjectUnion(obj: com.bryzek.apidoc.spec.v0.models.Union) = {
      play.api.libs.json.Json.obj(
        ...
        case None => play.api.libs.json.Json.obj()
        case Some(x) => play.api.libs.json.Json.obj("discriminator" -> play.api.libs.json.Json.toJson(x))
      }) ++
      (obj.description match {
        case None => play.api.libs.json.Json.obj()
        case Some(x) => play.api.libs.json.Json.obj("description" -> play.api.libs.json.Json.toJson(x))
...
=======
      (
        ...
        (__ \ "description").writeNullable[String] and
        (__ \ "deprecation").writeNullable[com.bryzek.apidoc.spec.v0.models.Deprecation] and
        (__ \ "types").write[Seq[com.bryzek.apidoc.spec.v0.models.UnionType]] and
        (__ \ "attributes").write[Seq[com.bryzek.apidoc.spec.v0.models.Attribute]]
...
<<<<<<< 7f4138aaa14fc32e55235ab5419a7ac37619ae3a
<<<<<<< 4c9bd867197bc1752a4c00133b07391b69738b8f
    val UserAgent = "apidoc:0.11.15 http://www.apidoc.me/bryzek/apidoc-spec/0.11.16/play_2_4_client"
=======
    val UserAgent = "apidoc:0.11.5 http://dockerhost:9000/bryzek/apidoc-spec/0.12.0-SNAPSHOT/play_2_4_client"
>>>>>>> Update tests to support attributes
    val Version = "0.11.16"
=======
    val UserAgent = "apidoc:0.9.48 http://dockerhost:9000/bryzek/apidoc-spec/0.9.49-SNAPSHOT/play_2_4_client"
    val Version = "0.9.49-SNAPSHOT"
>>>>>>> POC implementation of attributes
=======
    val UserAgent = "apidoc:0.11.5 http://dockerhost:9000/bryzek/apidoc-spec/0.12.0-SNAPSHOT/play_2_4_client"
