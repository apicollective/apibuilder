 ...
 * apidoc:0.11.8 http://localhost:9000/bryzek/apidoc-api/0.11.9/play_2_4_client
 */
...
package com.bryzek.apidoc.api.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apidoc:0.11.8 http://localhost:9000/bryzek/apidoc-api/0.11.9/play_2_4_client"
    val Version = "0.11.9"
    val VersionMajor = 0
  ...
  class Client(
    apiUrl: String = "http://api.apidoc.me",
  ...
  trait Attributes {
    ...
    /**
     * Deletes an attribute. Only the user who created an attribute can deleted it.
     */
    def deleteByGuid(
      guid: _root_.java.util.UUID
    )(implicit ec: scala.concurrent.ExecutionContext): scala.concurrent.Future[Unit]
