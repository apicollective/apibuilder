 ...
 * apidoc:0.10.1 http://localhost:9000/bryzek/apidoc-api/0.9.52/play_2_4_client
 */
...
package com.bryzek.apidoc.api.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apidoc:0.10.1 http://localhost:9000/bryzek/apidoc-api/0.9.52/play_2_4_client"
    val Version = "0.9.52"
    val VersionMajor = 0
