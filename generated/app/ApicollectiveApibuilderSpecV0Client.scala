 ...
 * apibuilder:0.12.38 http://localhost:9000/apicollective/apibuilder-spec/0.12.46/play_2_4_client
 */
package io.apibuilder.spec.v0.models {
  ...
  object Method {
     ...
     * above.
     */
    val all: List[Method] = List(Get, Post, Put, Patch, Delete, Head, Connect, Options, Trace)
  ...
  object ParameterLocation {
     ...
     * above.
     */
    val all: List[ParameterLocation] = List(Path, Query, Form, Header)
  ...
  object ResponseCodeOption {
     ...
     * above.
     */
    val all: List[ResponseCodeOption] = List(Default)
...
package io.apibuilder.spec.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apibuilder:0.12.38 http://localhost:9000/apicollective/apibuilder-spec/0.12.46/play_2_4_client"
    val Version = "0.12.46"
    val VersionMajor = 0
