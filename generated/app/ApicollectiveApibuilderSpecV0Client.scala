 ...
 * User agent: apibuilder app.apibuilder.io/apicollective/apibuilder-spec/latest/play_2_8_client
 */
...
package io.apibuilder.spec.v0.models {
  ...
  package object json {
    ...
    implicit def jsonReadsApibuilderSpecResponseCode: play.api.libs.json.Reads[io.apibuilder.spec.v0.models.ResponseCode] = {
      (
...
package io.apibuilder.spec.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apibuilder app.apibuilder.io/apicollective/apibuilder-spec/latest/play_2_8_client"
    val Version = "0.16.48"
    val VersionMajor = 0
