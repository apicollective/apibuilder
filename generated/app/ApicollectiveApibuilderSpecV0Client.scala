 ...
 * apibuilder:0.12.87 https://app.apibuilder.io/apicollective/apibuilder-spec/0.13.1/play_2_4_client
 */
package io.apibuilder.spec.v0.models {
   ...
   *        identify this type. If not specifiied, the discriminator value will default to
...
package io.apibuilder.spec.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apibuilder:0.12.87 https://app.apibuilder.io/apicollective/apibuilder-spec/0.13.1/play_2_4_client"
    val Version = "0.13.1"
    val VersionMajor = 0
