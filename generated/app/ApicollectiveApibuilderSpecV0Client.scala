 ...
 * User agent: apibuilder localhost 9000/apicollective/apibuilder-spec/latest/play_2_9_scala_3_client
 */
package io.apibuilder.spec.v0.models {
   ...
   *        discriminator and sets the default value for that discriminator during
   *        deserialization.
  ...
  package object json {
    ...
    implicit def jsonWritesApibuilderSpecMethod: play.api.libs.json.Writes[Method] = {
      (obj: io.apibuilder.spec.v0.models.Method) => {
        io.apibuilder.spec.v0.models.json.jsonWritesApibuilderSpecMethod(obj)
      }
    }
    ...
    implicit def jsonReadsApibuilderSpecAnnotation: play.api.libs.json.Reads[io.apibuilder.spec.v0.models.Annotation] = {
      for {
    ...
    implicit def jsonWritesApibuilderSpecAnnotation: play.api.libs.json.Writes[Annotation] = {
      (obj: io.apibuilder.spec.v0.models.Annotation) => {
        io.apibuilder.spec.v0.models.json.jsObjectAnnotation(obj)
      }
    }

    implicit def jsonReadsApibuilderSpecApidoc: play.api.libs.json.Reads[io.apibuilder.spec.v0.models.Apidoc] = {
      (__ \ "version").read[String].map { x => Apidoc(version = x) }
    }
    ...
    implicit def jsonWritesApibuilderSpecApidoc: play.api.libs.json.Writes[Apidoc] = {
      (obj: io.apibuilder.spec.v0.models.Apidoc) => {
        io.apibuilder.spec.v0.models.json.jsObjectApidoc(obj)
      }
    }

    implicit def jsonReadsApibuilderSpecApplication: play.api.libs.json.Reads[io.apibuilder.spec.v0.models.Application] = {
      (__ \ "key").read[String].map { x => Application(key = x) }
    }
    ...
    implicit def jsonWritesApibuilderSpecApplication: play.api.libs.json.Writes[Application] = {
      (obj: io.apibuilder.spec.v0.models.Application) => {
        io.apibuilder.spec.v0.models.json.jsObjectApplication(obj)
      }
    }

    implicit def jsonReadsApibuilderSpecAttribute: play.api.libs.json.Reads[io.apibuilder.spec.v0.models.Attribute] = {
      for {
        name <- (__ \ "name").read[String]
    ...
    implicit def jsonWritesApibuilderSpecAttribute: play.api.libs.json.Writes[Attribute] = {
      (obj: io.apibuilder.spec.v0.models.Attribute) => {
        io.apibuilder.spec.v0.models.json.jsObjectAttribute(obj)
      }
    }

    implicit def jsonReadsApibuilderSpecBody: play.api.libs.json.Reads[io.apibuilder.spec.v0.models.Body] = {
      for {
    ...
    implicit def jsonWritesApibuilderSpecBody: play.api.libs.json.Writes[Body] = {
      (obj: io.apibuilder.spec.v0.models.Body) => {
        io.apibuilder.spec.v0.models.json.jsObjectBody(obj)
      }
    }

    implicit def jsonReadsApibuilderSpecContact: play.api.libs.json.Reads[io.apibuilder.spec.v0.models.Contact] = {
      for {
    ...
    implicit def jsonWritesApibuilderSpecContact: play.api.libs.json.Writes[Contact] = {
      (obj: io.apibuilder.spec.v0.models.Contact) => {
        io.apibuilder.spec.v0.models.json.jsObjectContact(obj)
      }
    }

    implicit def jsonReadsApibuilderSpecDeprecation: play.api.libs.json.Reads[io.apibuilder.spec.v0.models.Deprecation] = {
    ...
    implicit def jsonWritesApibuilderSpecDeprecation: play.api.libs.json.Writes[Deprecation] = {
      (obj: io.apibuilder.spec.v0.models.Deprecation) => {
        io.apibuilder.spec.v0.models.json.jsObjectDeprecation(obj)
      }
    }

    implicit def jsonReadsApibuilderSpecEnum: play.api.libs.json.Reads[io.apibuilder.spec.v0.models.Enum] = {
      for {
        name <- (__ \ "name").read[String]
    ...
    implicit def jsonWritesApibuilderSpecEnum: play.api.libs.json.Writes[Enum] = {
      (obj: io.apibuilder.spec.v0.models.Enum) => {
        io.apibuilder.spec.v0.models.json.jsObjectEnum(obj)
      }
    }

    implicit def jsonReadsApibuilderSpecEnumValue: play.api.libs.json.Reads[io.apibuilder.spec.v0.models.EnumValue] = {
      for {
        name <- (__ \ "name").read[String]
        description <- (__ \ "description").readNullable[String]
        deprecation <- (__ \ "deprecation").readNullable[io.apibuilder.spec.v0.models.Deprecation]
    ...
    implicit def jsonWritesApibuilderSpecEnumValue: play.api.libs.json.Writes[EnumValue] = {
      (obj: io.apibuilder.spec.v0.models.EnumValue) => {
        io.apibuilder.spec.v0.models.json.jsObjectEnumValue(obj)
      }
    }

    implicit def jsonReadsApibuilderSpecField: play.api.libs.json.Reads[io.apibuilder.spec.v0.models.Field] = {
      for {
        name <- (__ \ "name").read[String]
        `type` <- (__ \ "type").read[String]
        description <- (__ \ "description").readNullable[String]
    ...
    implicit def jsonWritesApibuilderSpecField: play.api.libs.json.Writes[Field] = {
      (obj: io.apibuilder.spec.v0.models.Field) => {
        io.apibuilder.spec.v0.models.json.jsObjectField(obj)
      }
    }

    implicit def jsonReadsApibuilderSpecHeader: play.api.libs.json.Reads[io.apibuilder.spec.v0.models.Header] = {
      for {
        name <- (__ \ "name").read[String]
        `type` <- (__ \ "type").read[String]
        description <- (__ \ "description").readNullable[String]
    ...
    implicit def jsonWritesApibuilderSpecHeader: play.api.libs.json.Writes[Header] = {
      (obj: io.apibuilder.spec.v0.models.Header) => {
        io.apibuilder.spec.v0.models.json.jsObjectHeader(obj)
      }
    }

    implicit def jsonReadsApibuilderSpecImport: play.api.libs.json.Reads[io.apibuilder.spec.v0.models.Import] = {
      for {
    ...
    def jsObjectImport(obj: io.apibuilder.spec.v0.models.Import): play.api.libs.json.JsObject = {
      play.api.libs.json.Json.obj(
        ...
        "organization" -> io.apibuilder.spec.v0.models.json.jsObjectOrganization(obj.organization),
        "application" -> io.apibuilder.spec.v0.models.json.jsObjectApplication(obj.application),
        "version" -> play.api.libs.json.JsString(obj.version),
    ...
    implicit def jsonWritesApibuilderSpecImport: play.api.libs.json.Writes[Import] = {
      (obj: io.apibuilder.spec.v0.models.Import) => {
        io.apibuilder.spec.v0.models.json.jsObjectImport(obj)
      }
    }

    implicit def jsonReadsApibuilderSpecInfo: play.api.libs.json.Reads[io.apibuilder.spec.v0.models.Info] = {
      for {
    ...
    def jsObjectInfo(obj: io.apibuilder.spec.v0.models.Info): play.api.libs.json.JsObject = {
      (obj.license match {
        case None => play.api.libs.json.Json.obj()
        case Some(x) => play.api.libs.json.Json.obj("license" -> io.apibuilder.spec.v0.models.json.jsObjectLicense(x))
      }) ++
      (obj.contact match {
        case None => play.api.libs.json.Json.obj()
        case Some(x) => play.api.libs.json.Json.obj("contact" -> io.apibuilder.spec.v0.models.json.jsObjectContact(x))
      })
    }

    implicit def jsonWritesApibuilderSpecInfo: play.api.libs.json.Writes[Info] = {
      (obj: io.apibuilder.spec.v0.models.Info) => {
        io.apibuilder.spec.v0.models.json.jsObjectInfo(obj)
      }
    }

    implicit def jsonReadsApibuilderSpecInterface: play.api.libs.json.Reads[io.apibuilder.spec.v0.models.Interface] = {
      for {
        name <- (__ \ "name").read[String]
        plural <- (__ \ "plural").read[String]
        description <- (__ \ "description").readNullable[String]
    ...
    implicit def jsonWritesApibuilderSpecInterface: play.api.libs.json.Writes[Interface] = {
      (obj: io.apibuilder.spec.v0.models.Interface) => {
        io.apibuilder.spec.v0.models.json.jsObjectInterface(obj)
      }
    }

    implicit def jsonReadsApibuilderSpecLicense: play.api.libs.json.Reads[io.apibuilder.spec.v0.models.License] = {
      for {
        name <- (__ \ "name").read[String]
        url <- (__ \ "url").readNullable[String]
    ...
    implicit def jsonWritesApibuilderSpecLicense: play.api.libs.json.Writes[License] = {
      (obj: io.apibuilder.spec.v0.models.License) => {
        io.apibuilder.spec.v0.models.json.jsObjectLicense(obj)
      }
    }

    implicit def jsonReadsApibuilderSpecModel: play.api.libs.json.Reads[io.apibuilder.spec.v0.models.Model] = {
      for {
        name <- (__ \ "name").read[String]
        plural <- (__ \ "plural").read[String]
        description <- (__ \ "description").readNullable[String]
    ...
    implicit def jsonWritesApibuilderSpecModel: play.api.libs.json.Writes[Model] = {
      (obj: io.apibuilder.spec.v0.models.Model) => {
        io.apibuilder.spec.v0.models.json.jsObjectModel(obj)
      }
    }

    implicit def jsonReadsApibuilderSpecOperation: play.api.libs.json.Reads[io.apibuilder.spec.v0.models.Operation] = {
      for {
    ...
    def jsObjectOperation(obj: io.apibuilder.spec.v0.models.Operation): play.api.libs.json.JsObject = {
      ...
      (obj.body match {
        case None => play.api.libs.json.Json.obj()
        case Some(x) => play.api.libs.json.Json.obj("body" -> io.apibuilder.spec.v0.models.json.jsObjectBody(x))
      })
    }
    ...
    implicit def jsonWritesApibuilderSpecOperation: play.api.libs.json.Writes[Operation] = {
      (obj: io.apibuilder.spec.v0.models.Operation) => {
        io.apibuilder.spec.v0.models.json.jsObjectOperation(obj)
      }
    }

    implicit def jsonReadsApibuilderSpecOrganization: play.api.libs.json.Reads[io.apibuilder.spec.v0.models.Organization] = {
      (__ \ "key").read[String].map { x => Organization(key = x) }
    }
    ...
    implicit def jsonWritesApibuilderSpecOrganization: play.api.libs.json.Writes[Organization] = {
      (obj: io.apibuilder.spec.v0.models.Organization) => {
        io.apibuilder.spec.v0.models.json.jsObjectOrganization(obj)
      }
    }

    implicit def jsonReadsApibuilderSpecParameter: play.api.libs.json.Reads[io.apibuilder.spec.v0.models.Parameter] = {
      for {
        name <- (__ \ "name").read[String]
        `type` <- (__ \ "type").read[String]
    ...
    implicit def jsonWritesApibuilderSpecParameter: play.api.libs.json.Writes[Parameter] = {
      (obj: io.apibuilder.spec.v0.models.Parameter) => {
        io.apibuilder.spec.v0.models.json.jsObjectParameter(obj)
      }
    }

    implicit def jsonReadsApibuilderSpecResource: play.api.libs.json.Reads[io.apibuilder.spec.v0.models.Resource] = {
      for {
        `type` <- (__ \ "type").read[String]
        plural <- (__ \ "plural").read[String]
    ...
    implicit def jsonWritesApibuilderSpecResource: play.api.libs.json.Writes[Resource] = {
      (obj: io.apibuilder.spec.v0.models.Resource) => {
        io.apibuilder.spec.v0.models.json.jsObjectResource(obj)
      }
    }
    ...
    implicit def jsonWritesApibuilderSpecResponse: play.api.libs.json.Writes[Response] = {
      (obj: io.apibuilder.spec.v0.models.Response) => {
        io.apibuilder.spec.v0.models.json.jsObjectResponse(obj)
      }
    }

    implicit def jsonReadsApibuilderSpecService: play.api.libs.json.Reads[io.apibuilder.spec.v0.models.Service] = {
      for {
        apidoc <- (__ \ "apidoc").readNullable[io.apibuilder.spec.v0.models.Apidoc]
        name <- (__ \ "name").read[String]
        organization <- (__ \ "organization").read[io.apibuilder.spec.v0.models.Organization]
        application <- (__ \ "application").read[io.apibuilder.spec.v0.models.Application]
        namespace <- (__ \ "namespace").read[String]
    ...
    def jsObjectService(obj: io.apibuilder.spec.v0.models.Service): play.api.libs.json.JsObject = {
      play.api.libs.json.Json.obj(
        ...
        "namespace" -> play.api.libs.json.JsString(obj.namespace),
        "version" -> play.api.libs.json.JsString(obj.version),
        "info" -> io.apibuilder.spec.v0.models.json.jsObjectInfo(obj.info),
        ...
        case None => play.api.libs.json.Json.obj()
        case Some(x) => play.api.libs.json.Json.obj("apidoc" -> io.apibuilder.spec.v0.models.json.jsObjectApidoc(x))
      }) ++
      (obj.baseUrl match {
        case None => play.api.libs.json.Json.obj()
    ...
    implicit def jsonWritesApibuilderSpecService: play.api.libs.json.Writes[Service] = {
      (obj: io.apibuilder.spec.v0.models.Service) => {
        io.apibuilder.spec.v0.models.json.jsObjectService(obj)
      }
    }

    implicit def jsonReadsApibuilderSpecUnion: play.api.libs.json.Reads[io.apibuilder.spec.v0.models.Union] = {
      for {
        name <- (__ \ "name").read[String]
        plural <- (__ \ "plural").read[String]
    ...
    implicit def jsonWritesApibuilderSpecUnion: play.api.libs.json.Writes[Union] = {
      (obj: io.apibuilder.spec.v0.models.Union) => {
        io.apibuilder.spec.v0.models.json.jsObjectUnion(obj)
      }
    }

    implicit def jsonReadsApibuilderSpecUnionType: play.api.libs.json.Reads[io.apibuilder.spec.v0.models.UnionType] = {
      for {
        `type` <- (__ \ "type").read[String]
        description <- (__ \ "description").readNullable[String]
        deprecation <- (__ \ "deprecation").readNullable[io.apibuilder.spec.v0.models.Deprecation]
    ...
    implicit def jsonReadsApibuilderSpecResponseCode[T <: io.apibuilder.spec.v0.models.ResponseCode]: play.api.libs.json.Reads[T] = (json: play.api.libs.json.JsValue) => {
      Seq(
        (__ \ "integer").read(jsonReadsApibuilderSpecResponseCodeInt).reads(json).map(_.asInstanceOf[T]),
      ...
      obj match {
        ...
        case x: io.apibuilder.spec.v0.models.ResponseCodeUndefinedType => {
          scala.util.Try {
            ...
            case scala.util.Failure(_) => sys.error("The type[io.apibuilder.spec.v0.models.ResponseCodeUndefinedType] should never be serialized")
          }
        }
      }
    }
...
package io.apibuilder.spec.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apibuilder localhost 9000/apicollective/apibuilder-spec/latest/play_2_9_scala_3_client"
    val Version = "0.16.78"
    val VersionMajor = 0
