 ...
 * apibuilder 0.14.3 app.apibuilder.io/apicollective/apibuilder-spec/0.13.29/play_2_6_client
 */
...
package io.apibuilder.spec.v0 {
  ...
  object Bindables {
    ...
    val converterMethod: ApibuilderTypeConverter[io.apibuilder.spec.v0.models.Method] = new ApibuilderTypeConverter[io.apibuilder.spec.v0.models.Method] {
      ...
      override def example: io.apibuilder.spec.v0.models.Method = validValues.head
      override def validValues: Seq[io.apibuilder.spec.v0.models.Method] = io.apibuilder.spec.v0.models.Method.all
    }
    implicit val pathBindableMethod = ApibuilderPathBindable(converterMethod)
    implicit val queryStringBindableMethod = ApibuilderQueryStringBindable(converterMethod)

    val converterParameterLocation: ApibuilderTypeConverter[io.apibuilder.spec.v0.models.ParameterLocation] = new ApibuilderTypeConverter[io.apibuilder.spec.v0.models.ParameterLocation] {
      ...
      override def example: io.apibuilder.spec.v0.models.ParameterLocation = validValues.head
    ...
    implicit val pathBindableParameterLocation = ApibuilderPathBindable(converterParameterLocation)
    implicit val queryStringBindableParameterLocation = ApibuilderQueryStringBindable(converterParameterLocation)

    val converterResponseCodeOption: ApibuilderTypeConverter[io.apibuilder.spec.v0.models.ResponseCodeOption] = new ApibuilderTypeConverter[io.apibuilder.spec.v0.models.ResponseCodeOption] {
      ...
      override def example: io.apibuilder.spec.v0.models.ResponseCodeOption = validValues.head
    ...
    implicit val pathBindableResponseCodeOption = ApibuilderPathBindable(converterResponseCodeOption)
    implicit val queryStringBindableResponseCodeOption = ApibuilderQueryStringBindable(converterResponseCodeOption)
...
package io.apibuilder.spec.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apibuilder 0.14.3 app.apibuilder.io/apicollective/apibuilder-spec/0.13.29/play_2_6_client"
    val Version = "0.13.29"
    val VersionMajor = 0
