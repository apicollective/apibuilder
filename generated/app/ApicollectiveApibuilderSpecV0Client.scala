 ...
 * apibuilder 0.14.3 app.apibuilder.io/apicollective/apibuilder-spec/0.14.9/play_2_6_client
 */
...
package io.apibuilder.spec.v0 {
  ...
  object Bindables {
    ...
    object Models {
      ...
      implicit val pathBindableMethod: PathBindable[io.apibuilder.spec.v0.models.Method] = ApibuilderPathBindable(methodConverter)
      implicit val queryStringBindableMethod: QueryStringBindable[io.apibuilder.spec.v0.models.Method] = ApibuilderQueryStringBindable(methodConverter)
      ...
      implicit val pathBindableParameterLocation: PathBindable[io.apibuilder.spec.v0.models.ParameterLocation] = ApibuilderPathBindable(parameterLocationConverter)
      implicit val queryStringBindableParameterLocation: QueryStringBindable[io.apibuilder.spec.v0.models.ParameterLocation] = ApibuilderQueryStringBindable(parameterLocationConverter)
      ...
      implicit val pathBindableResponseCodeOption: PathBindable[io.apibuilder.spec.v0.models.ResponseCodeOption] = ApibuilderPathBindable(responseCodeOptionConverter)
      implicit val queryStringBindableResponseCodeOption: QueryStringBindable[io.apibuilder.spec.v0.models.ResponseCodeOption] = ApibuilderQueryStringBindable(responseCodeOptionConverter)
    }
...
package io.apibuilder.spec.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apibuilder 0.14.3 app.apibuilder.io/apicollective/apibuilder-spec/0.14.9/play_2_6_client"
    val Version = "0.14.9"
    val VersionMajor = 0
