 ...
 * apidoc:0.8.18 http://localhost:9000/gilt/apidoc/0.8.18/play_2_3_client
 */
package com.gilt.apidoc.api.v0.models {
  ...
  object OriginalType {
    ...
    def fromString(value: String): _root_.scala.Option[OriginalType] = byName.get(value)
...
package com.gilt.apidoc.api.v0.models {
  ...
  package object json {
    ...
    implicit val jsonReadsApidocOriginalType = __.read[String].map(OriginalType.apply)
    implicit val jsonWritesApidocOriginalType = new Writes[OriginalType] {
      def writes(x: OriginalType) = JsString(x.toString)
    }

    implicit val jsonReadsApidocPublication = __.read[String].map(Publication.apply)
    implicit val jsonWritesApidocPublication = new Writes[Publication] {
      def writes(x: Publication) = JsString(x.toString)
    }

    implicit val jsonReadsApidocVisibility = __.read[String].map(Visibility.apply)
    implicit val jsonWritesApidocVisibility = new Writes[Visibility] {
    ...
    implicit def jsonReadsApidocOriginal: play.api.libs.json.Reads[Original] = {
      (
    ...
    implicit def jsonWritesApidocOriginal: play.api.libs.json.Writes[Original] = {
      (
...
package com.gilt.apidoc.api.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apidoc:0.8.18 http://localhost:9000/gilt/apidoc/0.8.18/play_2_3_client"
    val Version = "0.8.18"
    val VersionMajor = 0
