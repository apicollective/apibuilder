 ...
 * Service version: 0.9.20-dev
 * apidoc:0.9.18 http://www.apidoc.me/gilt/apidoc-api/0.9.20-dev/play_2_3_client
 */
...
package com.gilt.apidoc.api.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apidoc:0.9.18 http://www.apidoc.me/gilt/apidoc-api/0.9.20-dev/play_2_3_client"
    val Version = "0.9.20-dev"
    val VersionMajor = 0
  ...
  class Client(
    ...
    object Applications extends Applications {
      ...
      override def postMoveByOrgKeyAndApplicationKey(
        orgKey: String,
        applicationKey: String,
        moveForm: com.gilt.apidoc.api.v0.models.MoveForm
      )(implicit ec: scala.concurrent.ExecutionContext): scala.concurrent.Future[com.gilt.apidoc.api.v0.models.Application] = {
