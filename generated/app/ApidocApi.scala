 ...
 * Service version: 0.9.29-dev
 * apidoc:0.9.29 http://localhost:9000/bryzek/apidoc-api/0.9.29-dev/play_2_3_client
 */
package com.bryzek.apidoc.api.v0.models {
  ...
  case class Application(
    ...
    organization: com.bryzek.apidoc.api.v0.models.Reference,
    name: String,
    key: String,
    visibility: com.bryzek.apidoc.api.v0.models.Visibility,
    description: _root_.scala.Option[String] = None,
    audit: com.bryzek.apidoc.api.v0.models.Audit
  )
  ...
  case class Audit(
    ...
    createdBy: com.bryzek.apidoc.api.v0.models.ReferenceGuid,
    updatedAt: _root_.org.joda.time.DateTime,
    updatedBy: com.bryzek.apidoc.api.v0.models.ReferenceGuid
  )
  ...
  case class Change(
    guid: _root_.java.util.UUID,
    organization: com.bryzek.apidoc.api.v0.models.Reference,
    application: com.bryzek.apidoc.api.v0.models.Reference,
  ...
  package object json {
    ...
    implicit def jsonReadsApidocapiApplication: play.api.libs.json.Reads[Application] = {
      (
        ...
        (__ \ "organization").read[com.bryzek.apidoc.api.v0.models.Reference] and
        (__ \ "name").read[String] and
        (__ \ "key").read[String] and
        (__ \ "visibility").read[com.bryzek.apidoc.api.v0.models.Visibility] and
        (__ \ "description").readNullable[String] and
        (__ \ "audit").read[com.bryzek.apidoc.api.v0.models.Audit]
      )(Application.apply _)
    }
    ...
    implicit def jsonWritesApidocapiApplication: play.api.libs.json.Writes[Application] = {
      (
        ...
        (__ \ "organization").write[com.bryzek.apidoc.api.v0.models.Reference] and
        (__ \ "name").write[String] and
        (__ \ "key").write[String] and
        (__ \ "visibility").write[com.bryzek.apidoc.api.v0.models.Visibility] and
        (__ \ "description").writeNullable[String] and
        (__ \ "audit").write[com.bryzek.apidoc.api.v0.models.Audit]
    ...
    implicit def jsonReadsApidocapiAudit: play.api.libs.json.Reads[Audit] = {
      (
        ...
        (__ \ "created_by").read[com.bryzek.apidoc.api.v0.models.ReferenceGuid] and
        (__ \ "updated_at").read[_root_.org.joda.time.DateTime] and
        (__ \ "updated_by").read[com.bryzek.apidoc.api.v0.models.ReferenceGuid]
      )(Audit.apply _)
    }
    ...
    implicit def jsonWritesApidocapiAudit: play.api.libs.json.Writes[Audit] = {
      (
        ...
        (__ \ "created_by").write[com.bryzek.apidoc.api.v0.models.ReferenceGuid] and
        (__ \ "updated_at").write[_root_.org.joda.time.DateTime] and
        (__ \ "updated_by").write[com.bryzek.apidoc.api.v0.models.ReferenceGuid]
    ...
    implicit def jsonReadsApidocapiChange: play.api.libs.json.Reads[Change] = {
      (
        (__ \ "guid").read[_root_.java.util.UUID] and
        (__ \ "organization").read[com.bryzek.apidoc.api.v0.models.Reference] and
        (__ \ "application").read[com.bryzek.apidoc.api.v0.models.Reference] and
    ...
    implicit def jsonWritesApidocapiChange: play.api.libs.json.Writes[Change] = {
      (
        (__ \ "guid").write[_root_.java.util.UUID] and
        (__ \ "organization").write[com.bryzek.apidoc.api.v0.models.Reference] and
        (__ \ "application").write[com.bryzek.apidoc.api.v0.models.Reference] and
...
package com.bryzek.apidoc.api.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apidoc:0.9.29 http://localhost:9000/bryzek/apidoc-api/0.9.29-dev/play_2_3_client"
    val Version = "0.9.29-dev"
    val VersionMajor = 0
  ...
  class Client(
    ...
    object Healthchecks extends Healthchecks {
      override def getInternalAndHealthcheck()(implicit ec: scala.concurrent.ExecutionContext): scala.concurrent.Future[com.bryzek.apidoc.api.v0.models.Healthcheck] = {
        _executeRequest("GET", s"/_internal_/healthcheck").map {
          case r if r.status == 200 => _root_.com.bryzek.apidoc.api.v0.Client.parseJson("com.bryzek.apidoc.api.v0.models.Healthcheck", r, _.validate[com.bryzek.apidoc.api.v0.models.Healthcheck])
          case r => throw new com.bryzek.apidoc.api.v0.errors.FailedRequest(r.status, s"Unsupported response code[${r.status}]. Expected: 200")
        }
      }
  ...
  trait Healthchecks {
    def getInternalAndHealthcheck()(implicit ec: scala.concurrent.ExecutionContext): scala.concurrent.Future[com.bryzek.apidoc.api.v0.models.Healthcheck]
