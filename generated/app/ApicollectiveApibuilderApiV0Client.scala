 ...
 * Service version: 0.16.78
 * User agent: apibuilder localhost 9000/apicollective/apibuilder-api/latest/play_2_9_scala_3_client
 */
package io.apibuilder.api.v0.models {
  ...
  final case class BatchDownloadApplications(
    applications: Seq[io.apibuilder.api.v0.models.Version]
  )

  final case class BatchDownloadApplicationsForm(
   ...
   *
   * @param latestVersion The latest version string, or absent if no versions exist for this application
   */
  ...
  /**
   * Form to request the latest version for multiple applications in a single API
   * call.
   *
   * @param applicationKeys List of application keys to look up
   */
...
package io.apibuilder.api.v0.models {
  ...
  package object json {
    ...
    def jsonReadsApibuilderApiApplicationSummary: play.api.libs.json.Reads[io.apibuilder.api.v0.models.ApplicationSummary] = {
      for {
        guid <- (__ \ "guid").read[_root_.java.util.UUID]
        organization <- (__ \ "organization").read[io.apibuilder.common.v0.models.Reference]
        key <- (__ \ "key").read[String]
    ...
    def jsonWritesApibuilderApiApplicationSummary: play.api.libs.json.Writes[ApplicationSummary] = {
    ...
    implicit def jsonReadsApibuilderApiBatchDownloadApplicationForm: play.api.libs.json.Reads[io.apibuilder.api.v0.models.BatchDownloadApplicationForm] = {
      for {
        applicationKey <- (__ \ "application_key").read[String]
        version <- (__ \ "version").readWithDefault[String]("latest")
      } yield BatchDownloadApplicationForm(applicationKey, version)
    }

    def jsObjectBatchDownloadApplicationForm(obj: io.apibuilder.api.v0.models.BatchDownloadApplicationForm): play.api.libs.json.JsObject = {
      play.api.libs.json.Json.obj(
    ...
    implicit def jsonWritesApibuilderApiBatchDownloadApplicationForm: play.api.libs.json.Writes[BatchDownloadApplicationForm] = {
      (obj: io.apibuilder.api.v0.models.BatchDownloadApplicationForm) => {
        io.apibuilder.api.v0.models.json.jsObjectBatchDownloadApplicationForm(obj)
      }
    }

    implicit def jsonReadsApibuilderApiBatchDownloadApplications: play.api.libs.json.Reads[io.apibuilder.api.v0.models.BatchDownloadApplications] = {
      (__ \ "applications").read[Seq[io.apibuilder.api.v0.models.Version]].map { x => BatchDownloadApplications(applications = x) }
    }

    def jsObjectBatchDownloadApplications(obj: io.apibuilder.api.v0.models.BatchDownloadApplications): play.api.libs.json.JsObject = {
      play.api.libs.json.Json.obj(
        "applications" -> play.api.libs.json.Json.toJson(obj.applications)
      )
    }

    implicit def jsonWritesApibuilderApiBatchDownloadApplications: play.api.libs.json.Writes[BatchDownloadApplications] = {
      (obj: io.apibuilder.api.v0.models.BatchDownloadApplications) => {
        io.apibuilder.api.v0.models.json.jsObjectBatchDownloadApplications(obj)
      }
    }

    implicit def jsonReadsApibuilderApiBatchDownloadApplicationsForm: play.api.libs.json.Reads[io.apibuilder.api.v0.models.BatchDownloadApplicationsForm] = {
      (__ \ "applications").read[Seq[io.apibuilder.api.v0.models.BatchDownloadApplicationForm]].map { x => BatchDownloadApplicationsForm(applications = x) }
    }

    def jsObjectBatchDownloadApplicationsForm(obj: io.apibuilder.api.v0.models.BatchDownloadApplicationsForm): play.api.libs.json.JsObject = {
      play.api.libs.json.Json.obj(
        "applications" -> play.api.libs.json.Json.toJson(obj.applications)
      )
    }

    implicit def jsonWritesApibuilderApiBatchDownloadApplicationsForm: play.api.libs.json.Writes[BatchDownloadApplicationsForm] = {
      (obj: io.apibuilder.api.v0.models.BatchDownloadApplicationsForm) => {
        io.apibuilder.api.v0.models.json.jsObjectBatchDownloadApplicationsForm(obj)
      }
    }
    ...
    implicit def jsonReadsApibuilderApiBatchVersionLatest: play.api.libs.json.Reads[io.apibuilder.api.v0.models.BatchVersionLatest] = {
      ...
      } yield BatchVersionLatest(applicationKey, latestVersion)
    }

    def jsObjectBatchVersionLatest(obj: io.apibuilder.api.v0.models.BatchVersionLatest): play.api.libs.json.JsObject = {
      play.api.libs.json.Json.obj(
        "application_key" -> play.api.libs.json.JsString(obj.applicationKey)
      ) ++ (obj.latestVersion match {
        case None => play.api.libs.json.Json.obj()
        case Some(x) => play.api.libs.json.Json.obj("latest_version" -> play.api.libs.json.JsString(x))
      })
    }
    ...
    def jsonReadsApibuilderApiDiffBreaking: play.api.libs.json.Reads[io.apibuilder.api.v0.models.DiffBreaking] = {
      for {
    ...
    def jsonReadsApibuilderApiDiffNonBreaking: play.api.libs.json.Reads[io.apibuilder.api.v0.models.DiffNonBreaking] = {
      for {
        description <- (__ \ "description").read[String]
        isMaterial <- (__ \ "is_material").read[Boolean]
    ...
    def jsonWritesApibuilderApiDiffNonBreaking: play.api.libs.json.Writes[DiffNonBreaking] = {
    ...
    implicit def jsonReadsApibuilderApiDiff[T <: io.apibuilder.api.v0.models.Diff]: play.api.libs.json.Reads[T] = (js: play.api.libs.json.JsValue) => {
    ...
    implicit def jsonReadsApibuilderApiDiffSeq[T <: io.apibuilder.api.v0.models.Diff]: play.api.libs.json.Reads[Seq[T]] = {
      case a: play.api.libs.json.JsArray => {
        val all: Seq[play.api.libs.json.JsResult[io.apibuilder.api.v0.models.Diff]] = a.value.map(jsonReadsApibuilderApiDiff.reads).toSeq
    ...
    implicit def jsonWritesApibuilderApiDiff[T <: io.apibuilder.api.v0.models.Diff]: play.api.libs.json.Writes[T] = {
    ...
    implicit def jsonReadsApibuilderApiItemDetail[T <: io.apibuilder.api.v0.models.ItemDetail]: play.api.libs.json.Reads[T] = (js: play.api.libs.json.JsValue) => {
      def readDiscriminator(discriminator: String) = {
        discriminator match {
    ...
    implicit def jsonReadsApibuilderApiItemDetailSeq[T <: io.apibuilder.api.v0.models.ItemDetail]: play.api.libs.json.Reads[Seq[T]] = {
      case a: play.api.libs.json.JsArray => {
        val all: Seq[play.api.libs.json.JsResult[io.apibuilder.api.v0.models.ItemDetail]] = a.value.map(jsonReadsApibuilderApiItemDetail.reads).toSeq
    ...
    implicit def jsonWritesApibuilderApiItemDetail[T <: io.apibuilder.api.v0.models.ItemDetail]: play.api.libs.json.Writes[T] = {
...
package io.apibuilder.api.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apibuilder localhost 9000/apicollective/apibuilder-api/latest/play_2_9_scala_3_client"
    val Version = "0.16.78"
    val VersionMajor = 0
  ...
  class Client(
    ...
    object BatchDownloadApplications extends BatchDownloadApplications {
      override def post(
        ...
        val payload = play.api.libs.json.Json.toJson(batchDownloadApplicationsForm)
  ...
  trait BatchDownloadApplications {
    /**
