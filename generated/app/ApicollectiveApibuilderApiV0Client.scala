 ...
 * apibuilder 0.14.3 app.apibuilder.io/apicollective/apibuilder-api/0.13.29/play_2_6_client
 */
...
package io.apibuilder.api.v0 {
  ...
  object Bindables {
    ...
    val converterOriginalType: ApibuilderTypeConverter[io.apibuilder.api.v0.models.OriginalType] = new ApibuilderTypeConverter[io.apibuilder.api.v0.models.OriginalType] {
      ...
      override def example: io.apibuilder.api.v0.models.OriginalType = validValues.head
      override def validValues: Seq[io.apibuilder.api.v0.models.OriginalType] = io.apibuilder.api.v0.models.OriginalType.all
    }
    implicit val pathBindableOriginalType = ApibuilderPathBindable(converterOriginalType)
    implicit val queryStringBindableOriginalType = ApibuilderQueryStringBindable(converterOriginalType)

    val converterPublication: ApibuilderTypeConverter[io.apibuilder.api.v0.models.Publication] = new ApibuilderTypeConverter[io.apibuilder.api.v0.models.Publication] {
      ...
      override def example: io.apibuilder.api.v0.models.Publication = validValues.head
      override def validValues: Seq[io.apibuilder.api.v0.models.Publication] = io.apibuilder.api.v0.models.Publication.all
    }
    implicit val pathBindablePublication = ApibuilderPathBindable(converterPublication)
    implicit val queryStringBindablePublication = ApibuilderQueryStringBindable(converterPublication)

    val converterVisibility: ApibuilderTypeConverter[io.apibuilder.api.v0.models.Visibility] = new ApibuilderTypeConverter[io.apibuilder.api.v0.models.Visibility] {
      ...
      override def example: io.apibuilder.api.v0.models.Visibility = validValues.head
      override def validValues: Seq[io.apibuilder.api.v0.models.Visibility] = io.apibuilder.api.v0.models.Visibility.all
    }
    implicit val pathBindableVisibility = ApibuilderPathBindable(converterVisibility)
    implicit val queryStringBindableVisibility = ApibuilderQueryStringBindable(converterVisibility)
...
package io.apibuilder.api.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apibuilder 0.14.3 app.apibuilder.io/apicollective/apibuilder-api/0.13.29/play_2_6_client"
    val Version = "0.13.29"
    val VersionMajor = 0
