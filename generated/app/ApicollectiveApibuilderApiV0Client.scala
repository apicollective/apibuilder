 ...
 * apidoc:0.11.94 http://www.apidoc.me/apicollective/apibuilder-api/0.12.1/play_2_4_client
 */
      ...
      def reads(js: play.api.libs.json.JsValue): play.api.libs.json.JsResult[Diff] = {
        (js \ "type").validateOpt[String] match {
          ...
          case play.api.libs.json.JsSuccess(discriminator, _) => {
            discriminator match {
              case Some("diff_breaking") => js.validate[io.apibuilder.api.v0.models.DiffBreaking]
              case Some("diff_non_breaking") => js.validate[io.apibuilder.api.v0.models.DiffNonBreaking]
              case Some(other) => play.api.libs.json.JsSuccess(io.apibuilder.api.v0.models.DiffUndefinedType(other))
    ...
    implicit def jsonReadsApibuilderapiItemDetail: play.api.libs.json.Reads[ItemDetail] = new play.api.libs.json.Reads[ItemDetail] {
      def reads(js: play.api.libs.json.JsValue): play.api.libs.json.JsResult[ItemDetail] = {
        (js \ "type").validateOpt[String] match {
          ...
          case play.api.libs.json.JsSuccess(discriminator, _) => {
            discriminator match {
              case Some("application_summary") => js.validate[io.apibuilder.api.v0.models.ApplicationSummary]
              case Some(other) => play.api.libs.json.JsSuccess(io.apibuilder.api.v0.models.ItemDetailUndefinedType(other))
...
package io.apibuilder.api.v0 {
  ...
  object Constants {
    ...
    val BaseUrl = "http://api.apibuilder.io"
    val Namespace = "io.apibuilder.api.v0"
    val UserAgent = "apidoc:0.11.94 http://www.apidoc.me/apicollective/apibuilder-api/0.12.1/play_2_4_client"
    val Version = "0.12.1"
    val VersionMajor = 0
  ...
  class Client(
    val baseUrl: String = "http://api.apibuilder.io",
