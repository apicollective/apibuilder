 ...
 * apibuilder:0.12.52 https://app.apibuilder.io/apicollective/apibuilder-api/0.12.58/play_2_4_client
 */
...
package io.apibuilder.api.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apibuilder:0.12.52 https://app.apibuilder.io/apicollective/apibuilder-api/0.12.58/play_2_4_client"
    val Version = "0.12.58"
    val VersionMajor = 0
  ...
  class Client(
    ...
    def applicationMetadata: ApplicationMetadata = ApplicationMetadata
    ...
    object ApplicationMetadata extends ApplicationMetadata {
      ...
      override def getVersionsAndLatestTxt(
        orgKey: String,
        applicationKey: String,
        requestHeaders: Seq[(String, String)] = Nil
  ...
  package interfaces {
    ...
    trait Client {
      def baseUrl: String
      def applicationMetadata: io.apibuilder.api.v0.ApplicationMetadata
