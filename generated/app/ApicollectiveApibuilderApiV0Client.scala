 ...
 * apibuilder app.apibuilder.io/apicollective/apibuilder-api/latest/play_2_8_client
 */
...
package io.apibuilder.api.v0.models {
  ...
  package object json {
    ...
    implicit def jsonReadsApibuilderApiBatchDownloadApplicationForm: play.api.libs.json.Reads[BatchDownloadApplicationForm] = {
      for {
    ...
    implicit def jsonReadsApibuilderApiBatchDownloadApplications: play.api.libs.json.Reads[BatchDownloadApplications] = {
      (__ \ "applications").read[Seq[io.apibuilder.api.v0.models.Version]].map { x => new BatchDownloadApplications(applications = x) }
    }
    ...
    implicit def jsonReadsApibuilderApiBatchDownloadApplicationsForm: play.api.libs.json.Reads[BatchDownloadApplicationsForm] = {
      (__ \ "applications").read[Seq[io.apibuilder.api.v0.models.BatchDownloadApplicationForm]].map { x => new BatchDownloadApplicationsForm(applications = x) }
    }
    ...
    implicit def jsonReadsApibuilderApiDiff: play.api.libs.json.Reads[Diff] = (js: play.api.libs.json.JsValue) => {
    ...
    implicit def jsonReadsApibuilderApiItemDetail: play.api.libs.json.Reads[ItemDetail] = (js: play.api.libs.json.JsValue) => {
      def readDiscriminator(discriminator: String) = {
        discriminator match {
