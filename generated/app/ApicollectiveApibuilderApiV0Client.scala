 ...
 * User agent: apibuilder app.apibuilder.io/apicollective/apibuilder-api/latest/play_2_9_scala_3_client
 */
  ...
  package object json {
    ...
    implicit def jsonWritesApibuilderApiBatchDownloadFormApplication: play.api.libs.json.Writes[BatchDownloadFormApplication] = {
      (obj: io.apibuilder.api.v0.models.BatchDownloadFormApplication) => {
        jsObjectBatchDownloadFormApplication(obj)
      }
    }
    ...
    implicit def jsonReadsApibuilderApiDiff[T <: io.apibuilder.api.v0.models.Diff]: play.api.libs.json.Reads[T] = (js: play.api.libs.json.JsValue) => {
      def readDiscriminator(discriminator: String) = {
        discriminator match {
          case "diff_breaking" => jsonReadsApibuilderApiDiffBreaking.reads(js)
          case "diff_non_breaking" => jsonReadsApibuilderApiDiffNonBreaking.reads(js)
    ...
    implicit def jsonReadsApibuilderApiItemDetail[T <: io.apibuilder.api.v0.models.ItemDetail]: play.api.libs.json.Reads[T] = (js: play.api.libs.json.JsValue) => {
      def readDiscriminator(discriminator: String) = {
        discriminator match {
          case "application_summary" => jsonReadsApibuilderApiApplicationSummary.reads(js)
...
package io.apibuilder.api.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apibuilder app.apibuilder.io/apicollective/apibuilder-api/latest/play_2_9_scala_3_client"
    val Version = "0.16.48"
    val VersionMajor = 0
