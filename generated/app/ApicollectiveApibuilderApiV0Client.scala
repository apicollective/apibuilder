 ...
 * apibuilder 0.14.3 localhost 9000/apicollective/apibuilder-api/0.14.13/play_2_6_client
 */
  ...
  package object json {
    ...
    implicit def jsonReadsApibuilderApiCode: play.api.libs.json.Reads[Code] = {
      (
        ...
        (__ \ "files").readWithDefault[Seq[io.apibuilder.generator.v0.models.File]](Nil)
      )(Code.apply _)
    }
    ...
    implicit def jsonReadsApibuilderApiOrganization: play.api.libs.json.Reads[Organization] = {
      (
        ...
        (__ \ "visibility").read[io.apibuilder.api.v0.models.Visibility] and
        (__ \ "domains").readWithDefault[Seq[io.apibuilder.api.v0.models.Domain]](Nil) and
        (__ \ "audit").read[io.apibuilder.common.v0.models.Audit]
    ...
    implicit def jsonReadsApibuilderApiOrganizationForm: play.api.libs.json.Reads[OrganizationForm] = {
      (
        ...
        (__ \ "key").readNullable[String] and
        (__ \ "namespace").read[String] and
        (__ \ "visibility").readWithDefault[io.apibuilder.api.v0.models.Visibility](io.apibuilder.api.v0.models.Visibility.Organization) and
    ...
    implicit def jsonReadsApibuilderApiValidation: play.api.libs.json.Reads[Validation] = {
      (
        ...
        (__ \ "errors").readWithDefault[Seq[String]](Nil)
      )(Validation.apply _)
    }
...
package io.apibuilder.api.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apibuilder 0.14.3 localhost 9000/apicollective/apibuilder-api/0.14.13/play_2_6_client"
    val Version = "0.14.13"
    val VersionMajor = 0
