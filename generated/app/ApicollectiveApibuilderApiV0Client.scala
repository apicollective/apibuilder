 ...
 * User agent: apibuilder app.apibuilder.io/apicollective/apibuilder-api/latest/play_2_8_client
 */
package io.apibuilder.api.v0.models {
  ...
  final case class BatchDownloadForm(
    applications: Seq[io.apibuilder.api.v0.models.BatchDownloadFormApplication]
  )

  final case class BatchDownloadFormApplication(
    applicationKey: String,
    version: String = "latest"
  )

  final case class BatchForm(
    applications: Seq[io.apibuilder.api.v0.models.VersionForm]
  )
  ...
  final case class DiffUndefinedType(
    ...
    override val diffType: DiffType = DiffType.UNDEFINED(typeDescription)
  ...
  object OriginalType {
     ...
     */
    case object ServiceJson extends OriginalType {
      override def toString = "service_json"
    }
    /**
     * The original in the Swagger JSON or YAML format
     */
    case object Swagger extends OriginalType {
      override def toString = "swagger"
    }
    /**
     * UNDEFINED captures values that are sent either in error or
     * that were added by the server after this library was
  ...
  object Publication {
     ...
     * change).
     */
    case object VersionsMaterialChange extends Publication {
      override def toString = "versions.material_change"
    }
    /**
     * UNDEFINED captures values that are sent either in error or
     * that were added by the server after this library was
...
package io.apibuilder.api.v0.models {
  ...
  package object json {
    ...
    implicit val jsonReadsApibuilderApiAppSortBy: play.api.libs.json.Reads[io.apibuilder.api.v0.models.AppSortBy] = new play.api.libs.json.Reads[io.apibuilder.api.v0.models.AppSortBy] {
    ...
    implicit def jsonWritesApibuilderApiAppSortBy: play.api.libs.json.Writes[AppSortBy] = {
      (obj: io.apibuilder.api.v0.models.AppSortBy) => {
        io.apibuilder.api.v0.models.json.jsonWritesApibuilderApiAppSortBy(obj)
      }
    }
    ...
    implicit def jsonWritesApibuilderApiBatchStatus: play.api.libs.json.Writes[BatchStatus] = {
      (obj: io.apibuilder.api.v0.models.BatchStatus) => {
        io.apibuilder.api.v0.models.json.jsonWritesApibuilderApiBatchStatus(obj)
      }
    }

    implicit val jsonReadsApibuilderApiOriginalType: play.api.libs.json.Reads[io.apibuilder.api.v0.models.OriginalType] = new play.api.libs.json.Reads[io.apibuilder.api.v0.models.OriginalType] {
    ...
    implicit def jsonWritesApibuilderApiOriginalType: play.api.libs.json.Writes[OriginalType] = {
      (obj: io.apibuilder.api.v0.models.OriginalType) => {
        io.apibuilder.api.v0.models.json.jsonWritesApibuilderApiOriginalType(obj)
      }
    }

    implicit val jsonReadsApibuilderApiPublication: play.api.libs.json.Reads[io.apibuilder.api.v0.models.Publication] = new play.api.libs.json.Reads[io.apibuilder.api.v0.models.Publication] {
    ...
    implicit def jsonWritesApibuilderApiPublication: play.api.libs.json.Writes[Publication] = {
      (obj: io.apibuilder.api.v0.models.Publication) => {
        io.apibuilder.api.v0.models.json.jsonWritesApibuilderApiPublication(obj)
      }
    }

    implicit val jsonReadsApibuilderApiSortOrder: play.api.libs.json.Reads[io.apibuilder.api.v0.models.SortOrder] = new play.api.libs.json.Reads[io.apibuilder.api.v0.models.SortOrder] {
    ...
    implicit def jsonWritesApibuilderApiSortOrder: play.api.libs.json.Writes[SortOrder] = {
      (obj: io.apibuilder.api.v0.models.SortOrder) => {
        io.apibuilder.api.v0.models.json.jsonWritesApibuilderApiSortOrder(obj)
      }
    }

    implicit val jsonReadsApibuilderApiVisibility: play.api.libs.json.Reads[io.apibuilder.api.v0.models.Visibility] = new play.api.libs.json.Reads[io.apibuilder.api.v0.models.Visibility] {
    ...
    implicit def jsonWritesApibuilderApiVisibility: play.api.libs.json.Writes[Visibility] = {
      (obj: io.apibuilder.api.v0.models.Visibility) => {
        io.apibuilder.api.v0.models.json.jsonWritesApibuilderApiVisibility(obj)
      }
    }

    implicit def jsonReadsApibuilderApiApplication: play.api.libs.json.Reads[io.apibuilder.api.v0.models.Application] = {
      for {
    ...
    implicit def jsonReadsApibuilderApiApplicationForm: play.api.libs.json.Reads[io.apibuilder.api.v0.models.ApplicationForm] = {
      for {
        name <- (__ \ "name").read[String]
    ...
    implicit def jsonReadsApibuilderApiApplicationMetadata: play.api.libs.json.Reads[io.apibuilder.api.v0.models.ApplicationMetadata] = {
      for {
        guid <- (__ \ "guid").read[_root_.java.util.UUID]
        key <- (__ \ "key").read[String]
    ...
    implicit def jsonWritesApibuilderApiApplicationMetadata: play.api.libs.json.Writes[ApplicationMetadata] = {
      (obj: io.apibuilder.api.v0.models.ApplicationMetadata) => {
        io.apibuilder.api.v0.models.json.jsObjectApplicationMetadata(obj)
      }
    }

    implicit def jsonReadsApibuilderApiApplicationMetadataVersion: play.api.libs.json.Reads[io.apibuilder.api.v0.models.ApplicationMetadataVersion] = {
      (__ \ "version").read[String].map { x => ApplicationMetadataVersion(version = x) }
    }
    ...
    implicit def jsonWritesApibuilderApiApplicationMetadataVersion: play.api.libs.json.Writes[ApplicationMetadataVersion] = {
      (obj: io.apibuilder.api.v0.models.ApplicationMetadataVersion) => {
        io.apibuilder.api.v0.models.json.jsObjectApplicationMetadataVersion(obj)
      }
    }

    implicit def jsonReadsApibuilderApiApplicationSummary: play.api.libs.json.Reads[io.apibuilder.api.v0.models.ApplicationSummary] = {
      for {
        guid <- (__ \ "guid").read[_root_.java.util.UUID]
        organization <- (__ \ "organization").read[io.apibuilder.common.v0.models.Reference]
        key <- (__ \ "key").read[String]
    ...
    implicit def jsonReadsApibuilderApiAttribute: play.api.libs.json.Reads[io.apibuilder.api.v0.models.Attribute] = {
      for {
        guid <- (__ \ "guid").read[_root_.java.util.UUID]
        name <- (__ \ "name").read[String]
        description <- (__ \ "description").readNullable[String]
    ...
    implicit def jsonReadsApibuilderApiAttributeForm: play.api.libs.json.Reads[io.apibuilder.api.v0.models.AttributeForm] = {
      for {
        name <- (__ \ "name").read[String]
        description <- (__ \ "description").readNullable[String]
    ...
    implicit def jsonReadsApibuilderApiAttributeSummary: play.api.libs.json.Reads[io.apibuilder.api.v0.models.AttributeSummary] = {
      for {
        guid <- (__ \ "guid").read[_root_.java.util.UUID]
        name <- (__ \ "name").read[String]
    ...
    implicit def jsonReadsApibuilderApiAttributeValue: play.api.libs.json.Reads[io.apibuilder.api.v0.models.AttributeValue] = {
      for {
        guid <- (__ \ "guid").read[_root_.java.util.UUID]
    ...
    implicit def jsonReadsApibuilderApiAttributeValueForm: play.api.libs.json.Reads[io.apibuilder.api.v0.models.AttributeValueForm] = {
    ...
    implicit def jsonReadsApibuilderApiAuthentication: play.api.libs.json.Reads[io.apibuilder.api.v0.models.Authentication] = {
      for {
    ...
    def jsObjectAuthentication(obj: io.apibuilder.api.v0.models.Authentication): play.api.libs.json.JsObject = {
      play.api.libs.json.Json.obj(
        ...
        "session" -> io.apibuilder.api.v0.models.json.jsObjectSession(obj.session)
      )
    }

    implicit def jsonWritesApibuilderApiAuthentication: play.api.libs.json.Writes[Authentication] = {
      (obj: io.apibuilder.api.v0.models.Authentication) => {
    ...
    def jsObjectBatch(obj: io.apibuilder.api.v0.models.Batch): play.api.libs.json.JsObject = {
      play.api.libs.json.Json.obj(
        ...
        case None => play.api.libs.json.Json.obj()
        case Some(x) => play.api.libs.json.Json.obj("data" -> io.apibuilder.api.v0.models.json.jsObjectBatchData(x))
      })
    }

    implicit def jsonWritesApibuilderApiBatch: play.api.libs.json.Writes[Batch] = {
      (obj: io.apibuilder.api.v0.models.Batch) => {
        io.apibuilder.api.v0.models.json.jsObjectBatch(obj)
      }
    }
    ...
    implicit def jsonWritesApibuilderApiBatchData: play.api.libs.json.Writes[BatchData] = {
      (obj: io.apibuilder.api.v0.models.BatchData) => {
        io.apibuilder.api.v0.models.json.jsObjectBatchData(obj)
      }
    }

    implicit def jsonReadsApibuilderApiBatchDownloadForm: play.api.libs.json.Reads[io.apibuilder.api.v0.models.BatchDownloadForm] = {
      (__ \ "applications").read[Seq[io.apibuilder.api.v0.models.BatchDownloadFormApplication]].map { x => BatchDownloadForm(applications = x) }
    }

    def jsObjectBatchDownloadForm(obj: io.apibuilder.api.v0.models.BatchDownloadForm): play.api.libs.json.JsObject = {
      play.api.libs.json.Json.obj(
        "applications" -> play.api.libs.json.Json.toJson(obj.applications)
      )
    }

    implicit def jsonWritesApibuilderApiBatchDownloadForm: play.api.libs.json.Writes[BatchDownloadForm] = {
      (obj: io.apibuilder.api.v0.models.BatchDownloadForm) => {
        io.apibuilder.api.v0.models.json.jsObjectBatchDownloadForm(obj)
      }
    }

    implicit def jsonReadsApibuilderApiBatchDownloadFormApplication: play.api.libs.json.Reads[io.apibuilder.api.v0.models.BatchDownloadFormApplication] = {
      for {
        applicationKey <- (__ \ "application_key").read[String]
        version <- (__ \ "version").readWithDefault[String]("latest")
      } yield BatchDownloadFormApplication(applicationKey, version)
    }

    def jsObjectBatchDownloadFormApplication(obj: io.apibuilder.api.v0.models.BatchDownloadFormApplication): play.api.libs.json.JsObject = {
      play.api.libs.json.Json.obj(
    ...
    implicit def jsonWritesApibuilderApiBatchDownloadFormApplication: play.api.libs.json.Writes[BatchDownloadFormApplication] = {
      (obj: io.apibuilder.api.v0.models.BatchDownloadFormApplication) => {
        io.apibuilder.api.v0.models.json.jsObjectBatchDownloadFormApplication(obj)
      }
    }

    implicit def jsonReadsApibuilderApiBatchForm: play.api.libs.json.Reads[io.apibuilder.api.v0.models.BatchForm] = {
      (__ \ "applications").read[Seq[io.apibuilder.api.v0.models.VersionForm]].map { x => BatchForm(applications = x) }
    }

    def jsObjectBatchForm(obj: io.apibuilder.api.v0.models.BatchForm): play.api.libs.json.JsObject = {
      play.api.libs.json.Json.obj(
        "applications" -> play.api.libs.json.Json.toJson(obj.applications)
      )
    }

    implicit def jsonWritesApibuilderApiBatchForm: play.api.libs.json.Writes[BatchForm] = {
      (obj: io.apibuilder.api.v0.models.BatchForm) => {
        io.apibuilder.api.v0.models.json.jsObjectBatchForm(obj)
      }
    }
    ...
    implicit def jsonReadsApibuilderApiChangeVersion: play.api.libs.json.Reads[io.apibuilder.api.v0.models.ChangeVersion] = {
      for {
        guid <- (__ \ "guid").read[_root_.java.util.UUID]
    ...
    implicit def jsonReadsApibuilderApiCleartextToken: play.api.libs.json.Reads[io.apibuilder.api.v0.models.CleartextToken] = {
    ...
    implicit def jsonReadsApibuilderApiCode: play.api.libs.json.Reads[io.apibuilder.api.v0.models.Code] = {
      for {
    ...
    implicit def jsonReadsApibuilderApiCodeForm: play.api.libs.json.Reads[io.apibuilder.api.v0.models.CodeForm] = {
      (__ \ "attributes").read[Seq[io.apibuilder.generator.v0.models.Attribute]].map { x => CodeForm(attributes = x) }
    }
    ...
    implicit def jsonWritesApibuilderApiCodeForm: play.api.libs.json.Writes[CodeForm] = {
      (obj: io.apibuilder.api.v0.models.CodeForm) => {
        io.apibuilder.api.v0.models.json.jsObjectCodeForm(obj)
      }
    }

    implicit def jsonReadsApibuilderApiDiffBreaking: play.api.libs.json.Reads[io.apibuilder.api.v0.models.DiffBreaking] = {
      for {
    ...
    implicit def jsonReadsApibuilderApiDiffNonBreaking: play.api.libs.json.Reads[io.apibuilder.api.v0.models.DiffNonBreaking] = {
      for {
        description <- (__ \ "description").read[String]
        isMaterial <- (__ \ "is_material").read[Boolean]
    ...
    implicit def jsonReadsApibuilderApiDomain: play.api.libs.json.Reads[io.apibuilder.api.v0.models.Domain] = {
    ...
    implicit def jsonReadsApibuilderApiEmailVerificationConfirmationForm: play.api.libs.json.Reads[io.apibuilder.api.v0.models.EmailVerificationConfirmationForm] = {
    ...
    implicit def jsonReadsApibuilderApiError: play.api.libs.json.Reads[io.apibuilder.api.v0.models.Error] = {
      for {
    ...
    implicit def jsonReadsApibuilderApiGeneratorForm: play.api.libs.json.Reads[io.apibuilder.api.v0.models.GeneratorForm] = {
      for {
    ...
    implicit def jsonReadsApibuilderApiGeneratorService: play.api.libs.json.Reads[io.apibuilder.api.v0.models.GeneratorService] = {
      for {
        guid <- (__ \ "guid").read[_root_.java.util.UUID]
    ...
    implicit def jsonReadsApibuilderApiGeneratorServiceForm: play.api.libs.json.Reads[io.apibuilder.api.v0.models.GeneratorServiceForm] = {
    ...
    implicit def jsonReadsApibuilderApiGeneratorWithService: play.api.libs.json.Reads[io.apibuilder.api.v0.models.GeneratorWithService] = {
      for {
    ...
    implicit def jsonReadsApibuilderApiItem: play.api.libs.json.Reads[io.apibuilder.api.v0.models.Item] = {
      for {
        guid <- (__ \ "guid").read[_root_.java.util.UUID]
    ...
    implicit def jsonReadsApibuilderApiMembership: play.api.libs.json.Reads[io.apibuilder.api.v0.models.Membership] = {
      for {
        guid <- (__ \ "guid").read[_root_.java.util.UUID]
        user <- (__ \ "user").read[io.apibuilder.api.v0.models.User]
    ...
    implicit def jsonReadsApibuilderApiMembershipRequest: play.api.libs.json.Reads[io.apibuilder.api.v0.models.MembershipRequest] = {
      for {
        guid <- (__ \ "guid").read[_root_.java.util.UUID]
        user <- (__ \ "user").read[io.apibuilder.api.v0.models.User]
        organization <- (__ \ "organization").read[io.apibuilder.api.v0.models.Organization]
    ...
    implicit def jsonReadsApibuilderApiMoveForm: play.api.libs.json.Reads[io.apibuilder.api.v0.models.MoveForm] = {
    ...
    implicit def jsonReadsApibuilderApiOrganization: play.api.libs.json.Reads[io.apibuilder.api.v0.models.Organization] = {
      for {
        guid <- (__ \ "guid").read[_root_.java.util.UUID]
        key <- (__ \ "key").read[String]
        name <- (__ \ "name").read[String]
    ...
    implicit def jsonReadsApibuilderApiOrganizationForm: play.api.libs.json.Reads[io.apibuilder.api.v0.models.OrganizationForm] = {
      for {
        name <- (__ \ "name").read[String]
        key <- (__ \ "key").readNullable[String]
        namespace <- (__ \ "namespace").read[String]
    ...
    implicit def jsonReadsApibuilderApiOriginal: play.api.libs.json.Reads[io.apibuilder.api.v0.models.Original] = {
      for {
    ...
    implicit def jsonReadsApibuilderApiOriginalForm: play.api.libs.json.Reads[io.apibuilder.api.v0.models.OriginalForm] = {
      for {
    ...
    implicit def jsonReadsApibuilderApiPasswordReset: play.api.libs.json.Reads[io.apibuilder.api.v0.models.PasswordReset] = {
      for {
    ...
    implicit def jsonReadsApibuilderApiPasswordResetRequest: play.api.libs.json.Reads[io.apibuilder.api.v0.models.PasswordResetRequest] = {
    ...
    implicit def jsonReadsApibuilderApiSession: play.api.libs.json.Reads[io.apibuilder.api.v0.models.Session] = {
      for {
        id <- (__ \ "id").read[String]
    ...
    implicit def jsonWritesApibuilderApiSession: play.api.libs.json.Writes[Session] = {
      (obj: io.apibuilder.api.v0.models.Session) => {
        io.apibuilder.api.v0.models.json.jsObjectSession(obj)
      }
    }

    implicit def jsonReadsApibuilderApiSubscription: play.api.libs.json.Reads[io.apibuilder.api.v0.models.Subscription] = {
      for {
        guid <- (__ \ "guid").read[_root_.java.util.UUID]
        organization <- (__ \ "organization").read[io.apibuilder.api.v0.models.Organization]
        user <- (__ \ "user").read[io.apibuilder.api.v0.models.User]
    ...
    implicit def jsonReadsApibuilderApiSubscriptionForm: play.api.libs.json.Reads[io.apibuilder.api.v0.models.SubscriptionForm] = {
      for {
    ...
    implicit def jsonReadsApibuilderApiToken: play.api.libs.json.Reads[io.apibuilder.api.v0.models.Token] = {
      for {
        guid <- (__ \ "guid").read[_root_.java.util.UUID]
        user <- (__ \ "user").read[io.apibuilder.api.v0.models.User]
    ...
    implicit def jsonReadsApibuilderApiTokenForm: play.api.libs.json.Reads[io.apibuilder.api.v0.models.TokenForm] = {
      for {
        userGuid <- (__ \ "user_guid").read[_root_.java.util.UUID]
        description <- (__ \ "description").readNullable[String]
    ...
    implicit def jsonReadsApibuilderApiUser: play.api.libs.json.Reads[io.apibuilder.api.v0.models.User] = {
      for {
        guid <- (__ \ "guid").read[_root_.java.util.UUID]
    ...
    implicit def jsonReadsApibuilderApiUserForm: play.api.libs.json.Reads[io.apibuilder.api.v0.models.UserForm] = {
      for {
        email <- (__ \ "email").read[String]
        password <- (__ \ "password").read[String]
    ...
    implicit def jsonReadsApibuilderApiUserSummary: play.api.libs.json.Reads[io.apibuilder.api.v0.models.UserSummary] = {
      for {
        guid <- (__ \ "guid").read[_root_.java.util.UUID]
        nickname <- (__ \ "nickname").read[String]
    ...
    implicit def jsonReadsApibuilderApiUserUpdateForm: play.api.libs.json.Reads[io.apibuilder.api.v0.models.UserUpdateForm] = {
      for {
        email <- (__ \ "email").read[String]
        nickname <- (__ \ "nickname").read[String]
        name <- (__ \ "name").readNullable[String]
    ...
    implicit def jsonReadsApibuilderApiValidation: play.api.libs.json.Reads[io.apibuilder.api.v0.models.Validation] = {
      for {
    ...
    implicit def jsonReadsApibuilderApiVersion: play.api.libs.json.Reads[io.apibuilder.api.v0.models.Version] = {
      for {
        guid <- (__ \ "guid").read[_root_.java.util.UUID]
        organization <- (__ \ "organization").read[io.apibuilder.common.v0.models.Reference]
        application <- (__ \ "application").read[io.apibuilder.common.v0.models.Reference]
    ...
    implicit def jsonReadsApibuilderApiVersionForm: play.api.libs.json.Reads[io.apibuilder.api.v0.models.VersionForm] = {
      for {
    ...
    implicit def jsonReadsApibuilderApiWatch: play.api.libs.json.Reads[io.apibuilder.api.v0.models.Watch] = {
      for {
        guid <- (__ \ "guid").read[_root_.java.util.UUID]
        user <- (__ \ "user").read[io.apibuilder.api.v0.models.User]
        organization <- (__ \ "organization").read[io.apibuilder.api.v0.models.Organization]
    ...
    implicit def jsonReadsApibuilderApiWatchForm: play.api.libs.json.Reads[io.apibuilder.api.v0.models.WatchForm] = {
      for {
        userGuid <- (__ \ "user_guid").read[_root_.java.util.UUID]
        organizationKey <- (__ \ "organization_key").read[String]
        applicationKey <- (__ \ "application_key").read[String]
    ...
    implicit def jsonReadsApibuilderApiDiff: play.api.libs.json.Reads[io.apibuilder.api.v0.models.Diff] = (js: play.api.libs.json.JsValue) => {
      def readDiscriminator(discriminator: String) = {
        discriminator match {
          case "diff_breaking" => io.apibuilder.api.v0.models.json.jsonReadsApibuilderApiDiffBreaking.reads(js)
          case "diff_non_breaking" => io.apibuilder.api.v0.models.json.jsonReadsApibuilderApiDiffNonBreaking.reads(js)
    ...
    implicit def jsonReadsApibuilderApiItemDetail: play.api.libs.json.Reads[io.apibuilder.api.v0.models.ItemDetail] = (js: play.api.libs.json.JsValue) => {
      def readDiscriminator(discriminator: String) = {
        discriminator match {
          case "application_summary" => io.apibuilder.api.v0.models.json.jsonReadsApibuilderApiApplicationSummary.reads(js)
...
package io.apibuilder.api.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apibuilder app.apibuilder.io/apicollective/apibuilder-api/latest/play_2_8_client"
    val Version = "0.16.48"
    val VersionMajor = 0
  ...
  class Client(
    ...
    object Batches extends Batches {
      override def post(
        orgKey: String,
        batchForm: io.apibuilder.api.v0.models.BatchForm,
        requestHeaders: Seq[(String, String)] = Nil
      )(implicit ec: scala.concurrent.ExecutionContext): scala.concurrent.Future[io.apibuilder.api.v0.models.Batch] = {
        val payload = play.api.libs.json.Json.toJson(batchForm)

        _executeRequest("POST", s"/${play.utils.UriEncoding.encodePathSegment(orgKey, "UTF-8")}/batch/applications", body = Some(payload), requestHeaders = requestHeaders).map {
          case r if r.status == 201 => _root_.io.apibuilder.api.v0.Client.parseJson("io.apibuilder.api.v0.models.Batch", r, _.validate[io.apibuilder.api.v0.models.Batch])
          case r if r.status == 409 => throw io.apibuilder.api.v0.errors.ErrorsResponse(r)
          case r => throw io.apibuilder.api.v0.errors.FailedRequest(r.status, s"Unsupported response code[${r.status}]. Expected: 201, 409")
        }
      }

      override def postDryrun(
        orgKey: String,
        batchDownloadForm: io.apibuilder.api.v0.models.BatchDownloadForm,
        requestHeaders: Seq[(String, String)] = Nil
      )(implicit ec: scala.concurrent.ExecutionContext): scala.concurrent.Future[io.apibuilder.api.v0.models.Batch] = {
        val payload = play.api.libs.json.Json.toJson(batchDownloadForm)

        _executeRequest("POST", s"/${play.utils.UriEncoding.encodePathSegment(orgKey, "UTF-8")}/batch/applications/dryrun", body = Some(payload), requestHeaders = requestHeaders).map {
          case r if r.status == 201 => _root_.io.apibuilder.api.v0.Client.parseJson("io.apibuilder.api.v0.models.Batch", r, _.validate[io.apibuilder.api.v0.models.Batch])
          case r if r.status == 409 => throw io.apibuilder.api.v0.errors.ErrorsResponse(r)
          case r => throw io.apibuilder.api.v0.errors.FailedRequest(r.status, s"Unsupported response code[${r.status}]. Expected: 201, 409")
        }
      ...
      override def postDownload(
        ...
        _executeRequest("POST", s"/${play.utils.UriEncoding.encodePathSegment(orgKey, "UTF-8")}/batch/applications/download", body = Some(payload), requestHeaders = requestHeaders).map {
          case r if r.status == 201 => _root_.io.apibuilder.api.v0.Client.parseJson("io.apibuilder.api.v0.models.Batch", r, _.validate[io.apibuilder.api.v0.models.Batch])
          case r if r.status == 409 => throw io.apibuilder.api.v0.errors.ErrorsResponse(r)
          case r => throw io.apibuilder.api.v0.errors.FailedRequest(r.status, s"Unsupported response code[${r.status}]. Expected: 201, 409")
        }
    ...
    object MembershipRequests extends MembershipRequests {
      override def get(
        ...
        role: _root_.scala.Option[io.apibuilder.common.v0.models.MembershipRole] = None,
        limit: Long = 25L,
        offset: Long = 0L,
        requestHeaders: Seq[(String, String)] = Nil
  ...
  package interfaces {
    ...
    trait Client {
      ...
      def batches: io.apibuilder.api.v0.Batches
  ...
  trait Batches {
    /**
     * Upsert multiple applications in one api call. Validation happens first - we
     * store results only if ALL applications are valid
     */
    def post(
      orgKey: String,
      batchForm: io.apibuilder.api.v0.models.BatchForm,
