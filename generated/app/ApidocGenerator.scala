 ...
 * apidoc:0.8.5 http://localhost:9000/gilt/apidoc-generator/0.0.1-dev/play_2_3_client
 */
...
package com.gilt.apidoc.generator.v0 {
  ...
  class Client(
    ...
    private val UserAgent = "apidoc:0.8.5 http://localhost:9000/gilt/apidoc-generator/0.0.1-dev/play_2_3_client"
