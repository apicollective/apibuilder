 ...
 * apidoc:0.8.27 http://localhost:9000/gilt/apidoc-generator/0.8.18/play_2_3_client
 */
...
package com.gilt.apidoc.generator.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apidoc:0.8.27 http://localhost:9000/gilt/apidoc-generator/0.8.18/play_2_3_client"
    val Version = "0.8.18"
    val VersionMajor = 0
