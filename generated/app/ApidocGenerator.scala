 ...
 * apidoc:0.7.39 http://localhost:9000/gilt/apidoc-generator/0.0.1/play_2_3_client
 */
package com.gilt.apidoc.generator.models {
...
package com.gilt.apidoc.generator.models {
  package object json {
    ...
    private[generator] implicit val jsonReadsUUID = __.read[String].map(java.util.UUID.fromString)

    private[generator] implicit val jsonWritesUUID = new Writes[java.util.UUID] {
      def writes(x: java.util.UUID) = JsString(x.toString)
    }

    private[generator] implicit val jsonReadsJodaDateTime = __.read[String].map { str =>
      import org.joda.time.format.ISODateTimeFormat.dateTimeParser
      dateTimeParser.parseDateTime(str)
    }

    private[generator] implicit val jsonWritesJodaDateTime = new Writes[org.joda.time.DateTime] {
...
package com.gilt.apidoc.generator {

  class Client(apiUrl: String, apiToken: scala.Option[String] = None) {
    import com.gilt.apidoc.generator.models.json._

    private val UserAgent = "apidoc:0.7.39 http://localhost:9000/gilt/apidoc-generator/0.0.1/play_2_3_client"
    private val logger = play.api.Logger("com.gilt.apidoc.generator.client")

    logger.info(s"Initializing com.gilt.apidoc.generator.client for url $apiUrl")
    ...
    object Generators extends Generators {
      override def get(
      ...
      )(implicit ec: scala.concurrent.ExecutionContext): scala.concurrent.Future[Seq[com.gilt.apidoc.generator.models.Generator]] = {
        ...
        _executeRequest("GET", s"/generators", queryParameters = queryParameters).map {
          case r if r.status == 200 => r.json.as[Seq[com.gilt.apidoc.generator.models.Generator]]
      ...
      override def getByKey(
        key: String
      )(implicit ec: scala.concurrent.ExecutionContext): scala.concurrent.Future[_root_.scala.Option[com.gilt.apidoc.generator.models.Generator]] = {
        _executeRequest("GET", s"/generators/${play.utils.UriEncoding.encodePathSegment(key, "UTF-8")}").map {
          case r if r.status == 200 => Some(r.json.as[com.gilt.apidoc.generator.models.Generator])
    ...
    object Healthchecks extends Healthchecks {
      override def getInternalAndHealthcheck()(implicit ec: scala.concurrent.ExecutionContext): scala.concurrent.Future[_root_.scala.Option[com.gilt.apidoc.generator.models.Healthcheck]] = {
        _executeRequest("GET", s"/_internal_/healthcheck").map {
          case r if r.status == 200 => Some(r.json.as[com.gilt.apidoc.generator.models.Healthcheck])
          case r if r.status == 404 => None
          case r => throw new FailedRequest(r)
        }
      }
    ...
    object Invocations extends Invocations {
      override def postByKey(
        ...
        _executeRequest("POST", s"/invocations/${play.utils.UriEncoding.encodePathSegment(key, "UTF-8")}", body = Some(payload)).map {
          case r if r.status == 200 => r.json.as[com.gilt.apidoc.generator.models.Invocation]
          case r if r.status == 409 => throw new com.gilt.apidoc.generator.error.ErrorsResponse(r)
          case r => throw new FailedRequest(r)
        }
      }
    }
  ...
  trait Healthchecks {
    def getInternalAndHealthcheck()(implicit ec: scala.concurrent.ExecutionContext): scala.concurrent.Future[_root_.scala.Option[com.gilt.apidoc.generator.models.Healthcheck]]
  }
  ...
  package error {
    ...
    case class ErrorsResponse(
      ...
      import com.gilt.apidoc.generator.models.json._
      lazy val errors = response.json.as[Seq[com.gilt.apidoc.generator.models.Error]]
    }
  }
  ...
  object Bindables {
    ...
    import com.gilt.apidoc.generator.models._
