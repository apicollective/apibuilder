 ...
 * apidoc:0.9.14 http://localhost:9000/gilt/apidoc-generator/0.9.15/play_2_3_client
 */
...
package com.gilt.apidoc.generator.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apidoc:0.9.14 http://localhost:9000/gilt/apidoc-generator/0.9.15/play_2_3_client"
    val Version = "0.9.15"
    val VersionMajor = 0
  ...
  class Client(
    ...
    object Generators extends Generators {
      ...
      override def getByKey(
        ...
        _executeRequest("GET", s"/generators/${play.utils.UriEncoding.encodePathSegment(key, "UTF-8")}").map {
          case r if r.status == 200 => _root_.com.gilt.apidoc.generator.v0.Client.parseJson("com.gilt.apidoc.generator.v0.models.Generator", r, _.validate[com.gilt.apidoc.generator.v0.models.Generator])
          case r if r.status == 404 => throw new com.gilt.apidoc.generator.v0.errors.UnitResponse(r.status)
    ...
    object Healthchecks extends Healthchecks {
      override def getInternalAndHealthcheck()(implicit ec: scala.concurrent.ExecutionContext): scala.concurrent.Future[com.gilt.apidoc.generator.v0.models.Healthcheck] = {
        _executeRequest("GET", s"/_internal_/healthcheck").map {
          case r if r.status == 200 => _root_.com.gilt.apidoc.generator.v0.Client.parseJson("com.gilt.apidoc.generator.v0.models.Healthcheck", r, _.validate[com.gilt.apidoc.generator.v0.models.Healthcheck])
          case r => throw new com.gilt.apidoc.generator.v0.errors.FailedRequest(r.status, s"Unsupported response code[${r.status}]. Expected: 200")
        }
      }
    }
  ...
  trait Healthchecks {
    def getInternalAndHealthcheck()(implicit ec: scala.concurrent.ExecutionContext): scala.concurrent.Future[com.gilt.apidoc.generator.v0.models.Healthcheck]
  }
