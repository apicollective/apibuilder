 ...
 * apidoc:0.7.39 http://localhost:9000/gilt/apidoc/0.7.39/play_2_3_client
 */
package com.gilt.apidoc.models {
  ...
  case class GeneratorUpdateForm(
    visibility: _root_.scala.Option[com.gilt.apidoc.models.Visibility] = None,
  ...
  package object json {
    ...
    implicit def jsonReadsApidocWatch: play.api.libs.json.Reads[Watch] = {
      (
        ...
        (__ \ "user").read[com.gilt.apidoc.models.User] and
        (__ \ "organization").read[com.gilt.apidoc.models.Organization] and
        (__ \ "application").read[com.gilt.apidoc.models.Application]
      )(Watch.apply _)
    }
    ...
    implicit def jsonWritesApidocWatch: play.api.libs.json.Writes[Watch] = {
      (
        ...
        (__ \ "user").write[com.gilt.apidoc.models.User] and
        (__ \ "organization").write[com.gilt.apidoc.models.Organization] and
        (__ \ "application").write[com.gilt.apidoc.models.Application]
...
package com.gilt.apidoc {
  ...
  class Client(apiUrl: String, apiToken: scala.Option[String] = None) {
    ...
    private val UserAgent = "apidoc:0.7.39 http://localhost:9000/gilt/apidoc/0.7.39/play_2_3_client"
    ...
    object Applications extends Applications {
      override def getByOrgKey(
      ...
      )(implicit ec: scala.concurrent.ExecutionContext): scala.concurrent.Future[Seq[com.gilt.apidoc.models.Application]] = {
        ...
        _executeRequest("GET", s"/${play.utils.UriEncoding.encodePathSegment(orgKey, "UTF-8")}", queryParameters = queryParameters).map {
          case r if r.status == 200 => r.json.as[Seq[com.gilt.apidoc.models.Application]]
      ...
      override def postByOrgKey(applicationForm: com.gilt.apidoc.models.ApplicationForm,
        ...
        _executeRequest("POST", s"/${play.utils.UriEncoding.encodePathSegment(orgKey, "UTF-8")}", body = Some(payload)).map {
          case r if r.status == 200 => r.json.as[com.gilt.apidoc.models.Application]
    ...
    object Code extends Code {
      override def getByOrgKeyAndApplicationKeyAndVersionAndGeneratorKey(
        ...
        version: String,
        generatorKey: String
      )(implicit ec: scala.concurrent.ExecutionContext): scala.concurrent.Future[_root_.scala.Option[com.gilt.apidoc.models.Code]] = {
    ...
    object Healthchecks extends Healthchecks {
      override def getInternalAndHealthcheck()(implicit ec: scala.concurrent.ExecutionContext): scala.concurrent.Future[_root_.scala.Option[com.gilt.apidoc.models.Healthcheck]] = {
    ...
    object Memberships extends Memberships {
      ...
      override def getByGuid(
        guid: _root_.java.util.UUID
      )(implicit ec: scala.concurrent.ExecutionContext): scala.concurrent.Future[_root_.scala.Option[com.gilt.apidoc.models.Membership]] = {
    ...
    object Organizations extends Organizations {
      ...
      override def getByKey(
        key: String
      )(implicit ec: scala.concurrent.ExecutionContext): scala.concurrent.Future[_root_.scala.Option[com.gilt.apidoc.models.Organization]] = {
    ...
    object Subscriptions extends Subscriptions {
      override def get(
        ...
        userGuid: _root_.scala.Option[_root_.java.util.UUID] = None,
        publication: _root_.scala.Option[com.gilt.apidoc.models.Publication] = None,
        limit: _root_.scala.Option[Long] = None,
        offset: _root_.scala.Option[Long] = None
      ...
      override def getByGuid(
        guid: _root_.java.util.UUID
      )(implicit ec: scala.concurrent.ExecutionContext): scala.concurrent.Future[_root_.scala.Option[com.gilt.apidoc.models.Subscription]] = {
    ...
    object Users extends Users {
      ...
      override def getByGuid(
        guid: _root_.java.util.UUID
      )(implicit ec: scala.concurrent.ExecutionContext): scala.concurrent.Future[_root_.scala.Option[com.gilt.apidoc.models.User]] = {
    ...
    object Versions extends Versions {
      ...
      override def getByOrgKeyAndApplicationKeyAndVersion(
        ...
        applicationKey: String,
        version: String
      )(implicit ec: scala.concurrent.ExecutionContext): scala.concurrent.Future[_root_.scala.Option[com.gilt.apidoc.models.Version]] = {
    ...
    object Watches extends Watches {
      ...
      override def getByGuid(
        guid: _root_.java.util.UUID
      )(implicit ec: scala.concurrent.ExecutionContext): scala.concurrent.Future[_root_.scala.Option[com.gilt.apidoc.models.Watch]] = {
  ...
  trait Healthchecks {
    def getInternalAndHealthcheck()(implicit ec: scala.concurrent.ExecutionContext): scala.concurrent.Future[_root_.scala.Option[com.gilt.apidoc.models.Healthcheck]]
  }
