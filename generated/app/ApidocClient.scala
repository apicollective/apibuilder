 ...
 * apidoc:0.7.39 http://www.apidoc.me/gilt/apidoc/0.7.39-dev/play_2_3_client
 */
...
package com.gilt.apidoc {
  ...
  class Client(apiUrl: String, apiToken: scala.Option[String] = None) {
    ...
    private val UserAgent = "apidoc:0.7.39 http://www.apidoc.me/gilt/apidoc/0.7.39-dev/play_2_3_client"
    ...
    object EmailVerificationConfirmationForms extends EmailVerificationConfirmationForms {
      override def post(emailVerificationConfirmationForm: com.gilt.apidoc.models.EmailVerificationConfirmationForm)(implicit ec: scala.concurrent.ExecutionContext): scala.concurrent.Future[Unit] = {
    ...
    object Watches extends Watches {
      override def get(
        ...
        userGuid: scala.Option[_root_.java.util.UUID] = None,
        organizationKey: scala.Option[String] = None,
        applicationKey: scala.Option[String] = None,
        limit: scala.Option[Long] = None,
        offset: scala.Option[Long] = None
  ...
  trait EmailVerificationConfirmationForms {
     ...
     */
    def post(emailVerificationConfirmationForm: com.gilt.apidoc.models.EmailVerificationConfirmationForm)(implicit ec: scala.concurrent.ExecutionContext): scala.concurrent.Future[Unit]
  }
  ...
  trait Versions {
    ...
    /**
     * Upsert this version of the service api
     */
